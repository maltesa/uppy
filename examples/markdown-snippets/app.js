 ...
 ${info.details}`)
  ...
  var require_mini_legacy_umd = __commonJS({
    "../node_modules/exifr/dist/mini.legacy.umd.js"(exports, module) {
      !function(e2, t2) {
        typeof exports == "object" && typeof module != "undefined" ? t2(exports) : typeof define == "function" && define.amd ? define("exifr", ["exports"], t2) : t2((e2 = typeof globalThis != "undefined" ? globalThis : e2 || self).exifr = {});
      }(exports, function(e2) {
        "use strict";
        function t2(e3, t3) {
          if (!(e3 instanceof t3))
        ...
        function a2(e3, t3) {
          ...
          Object.getOwnPropertyNames(t3).forEach(function(r3) {
            n3.indexOf(r3) === -1 && e3[r3] !== t3[r3] && (e3[r3] = t3[r3]);
          }), t3 && u2(e3, t3);
        }
        function s2(e3) {
        ...
        function f2(e3, t3, n3) {
          return (f2 = o2() ? Reflect.construct : function(e4, t4, n4) {
            var r3 = [null];
            r3.push.apply(r3, t4);
            var i3 = new (Function.bind.apply(e4, r3))();
            return n4 && u2(i3, n4.prototype), i3;
        ...
        function c2(e3) {
          ...
          return (c2 = function(e4) {
            ...
            function r3() {
              return f2(e4, arguments, s2(this).constructor);
            }
        ...
        function l2(e3, t3) {
          return !t3 || typeof t3 != "object" && typeof t3 != "function" ? h2(e3) : t3;
        }
        function d2(e3) {
          var t3 = o2();
          return function() {
        ...
        function v2(e3, t3, n3) {
          return (v2 = typeof Reflect != "undefined" && Reflect.get ? Reflect.get : function(e4, t4, n4) {
            var r3 = function(e5, t5) {
              for (; !Object.prototype.hasOwnProperty.call(e5, t5) && (e5 = s2(e5)) !== null; )
                ;
              return e5;
            }(e4, t4);
            if (r3) {
              var i3 = Object.getOwnPropertyDescriptor(r3, t4);
              return i3.get ? i3.get.call(n4) : i3.value;
            }
          })(e3, t3, n3 || e3);
        }
        var p2 = Object.values || function(e3) {
          var t3 = [];
          for (var n3 in e3)
            t3.push(e3[n3]);
          return t3;
        }, y2 = Object.entries || function(e3) {
          var t3 = [];
          for (var n3 in e3)
            t3.push([n3, e3[n3]]);
          return t3;
        }, g2 = Object.assign || function(e3) {
        ...
        }, k2 = Object.fromEntries || function(e3) {
          var t3 = {};
          return m2(e3).forEach(function(e4) {
            var n3 = e4[0], r3 = e4[1];
            t3[n3] = r3;
          }), t3;
        }, m2 = Array.from || function(e3) {
          if (e3 instanceof P2) {
            var t3 = [];
        ...
        Array.prototype.includes || (Array.prototype.includes = b2), String.prototype.includes || (String.prototype.includes = b2), String.prototype.startsWith || (String.prototype.startsWith = function(e3) {
          var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
          return this.substring(t3, t3 + e3.length) === e3;
        }), String.prototype.endsWith || (String.prototype.endsWith = function(e3) {
          var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.length;
          return this.substring(t3 - e3.length, t3) === e3;
        });
        var A2 = typeof self != "undefined" ? self : global, w2 = A2.fetch || function(e3) {
          var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          return new Promise(function(n3, r3) {
            var i3 = new XMLHttpRequest();
            if (i3.open("get", e3, true), i3.responseType = "arraybuffer", i3.onerror = r3, t3.headers)
              for (var a3 in t3.headers)
                i3.setRequestHeader(a3, t3.headers[a3]);
            i3.onload = function() {
              n3({
                ok: i3.status >= 200 && i3.status < 300,
                status: i3.status,
                arrayBuffer: function() {
                  return Promise.resolve(i3.response);
                }
              });
            }, i3.send(null);
          });
          ...
          return new P2(e3);
        }, P2 = A2.Map !== void 0 && A2.Map.prototype.keys !== void 0 ? A2.Map : function() {
          function e3(n3) {
            if (t2(this, e3), this.clear(), n3)
              for (var r3 = 0; r3 < n3.length; r3++)
                this.set(n3[r3][0], n3[r3][1]);
          }
          return r2(e3, [{
            key: "clear",
            value: function() {
            ...
            key: "get",
            value: function(e4) {
              return this._map["map_" + e4];
            }
          }, {
            key: "set",
            value: function(e4, t3) {
              return this._map["map_" + e4] = t3, this._keys.indexOf(e4) < 0 && this._keys.push(e4), this;
            }
          }, {
            key: "has",
            value: function(e4) {
              return this._keys.indexOf(e4) >= 0;
            }
          }, {
            key: "delete",
            value: function(e4) {
              var t3 = this._keys.indexOf(e4);
              return !(t3 < 0) && (delete this._map["map_" + e4], this._keys.splice(t3, 1), true);
            }
          }, {
            key: "keys",
            value: function() {
            ...
            value: function() {
              var e4 = this;
              return this._keys.map(function(t3) {
                return e4.get(t3);
              });
            }
          }, {
            ...
            value: function(e4, t3) {
              for (var n3 = 0; n3 < this._keys.length; n3++)
                e4.call(t3, this._map["map_" + this._keys[n3]], this._keys[n3], this);
            }
          }]), e3;
        }(), U = typeof self != "undefined" ? self : global, x2 = typeof navigator != "undefined", C2 = x2 && typeof HTMLImageElement == "undefined", B2 = !(typeof global == "undefined" || typeof process == "undefined" || !process.versions || !process.versions.node), j2 = U.Buffer, _2 = !!j2;
        var V = function(e3) {
          return e3 !== void 0;
        };
        function I2(e3) {
          return e3 === void 0 || (e3 instanceof P2 ? e3.size === 0 : p2(e3).filter(V).length === 0);
        }
        function L2(e3) {
          var t3 = new Error(e3);
        ...
        }, F = typeof TextDecoder != "undefined" ? new TextDecoder("utf-8") : void 0;
        function E(e3) {
          return F ? F.decode(e3) : _2 ? Buffer.from(e3).toString("utf8") : decodeURIComponent(escape(z2(e3)));
        }
        var D2 = function() {
          function e3(n3) {
            var r3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i3 = arguments.length > 2 ? arguments[2] : void 0, a3 = arguments.length > 3 ? arguments[3] : void 0;
            if (t2(this, e3), typeof a3 == "boolean" && (this.le = a3), Array.isArray(n3) && (n3 = new Uint8Array(n3)), n3 === 0)
              this.byteOffset = 0, this.byteLength = 0;
            else if (n3 instanceof ArrayBuffer) {
              i3 === void 0 && (i3 = n3.byteLength - r3);
              var s3 = new DataView(n3, r3, i3);
              this._swapDataView(s3);
            } else if (n3 instanceof Uint8Array || n3 instanceof DataView || n3 instanceof e3) {
              i3 === void 0 && (i3 = n3.byteLength - r3), (r3 += n3.byteOffset) + i3 > n3.byteOffset + n3.byteLength && L2("Creating view outside of available memory in ArrayBuffer");
              var u3 = new DataView(n3.buffer, r3, i3);
              this._swapDataView(u3);
            } else if (typeof n3 == "number") {
              var o3 = new DataView(new ArrayBuffer(n3));
              this._swapDataView(o3);
            } else
          ...
          return r2(e3, [{
            ...
            value: function(t3, n3) {
              var r3 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : e3;
              t3 instanceof DataView || t3 instanceof e3 ? t3 = new Uint8Array(t3.buffer, t3.byteOffset, t3.byteLength) : t3 instanceof ArrayBuffer && (t3 = new Uint8Array(t3)), t3 instanceof Uint8Array || L2("BufferView.set(): Invalid data argument.");
              var i3 = this.toUint8();
              return i3.set(t3, n3), new r3(this, n3, t3.byteLength);
            }
          }, {
            key: "subarray",
            value: function(t3, n3) {
              return new e3(this, t3, n3 = n3 || this._lengthToEnd(t3));
            }
          }, {
            key: "toUint8",
            value: function() {
            ...
            key: "getUint8Array",
            value: function(e4, t3) {
              return new Uint8Array(this.buffer, this.byteOffset + e4, t3);
            }
          }, {
            key: "getString",
            value: function() {
              var e4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.byteLength, n3 = this.getUint8Array(e4, t3);
              return E(n3);
            }
          }, {
            key: "getLatin1String",
            ...
            value: function() {
              for (var e4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.byteLength, n3 = [], r3 = 0; r3 < t3 && e4 + r3 < this.byteLength; r3 += 2)
                n3.push(this.getUint16(e4 + r3));
              return z2(n3);
            }
          }, {
            key: "getInt8",
            ...
            key: "getInt16",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getInt16(e4, t3);
            }
          }, {
            key: "getInt32",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getInt32(e4, t3);
            }
          }, {
            key: "getUint16",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getUint16(e4, t3);
            }
          }, {
            key: "getUint32",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getUint32(e4, t3);
            }
          }, {
            key: "getFloat32",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getFloat32(e4, t3);
            }
          }, {
            key: "getFloat64",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getFloat64(e4, t3);
            }
          }, {
            key: "getFloat",
            value: function(e4) {
            ...
            value: function(e4, t3, n3) {
              switch (t3) {
                case 1:
                  return this.getUint8(e4, n3);
                case 2:
                  return this.getUint16(e4, n3);
                case 4:
                  return this.getUint32(e4, n3);
                case 8:
                  return this.getUint64 && this.getUint64(e4, n3);
              }
            }
          }, {
            key: "getUint",
            ...
            key: "from",
            value: function(t3, n3) {
              return t3 instanceof this && t3.le === n3 ? t3 : new e3(t3, void 0, void 0, n3);
            }
          }]), e3;
        }();
        function R(e3, t3) {
          L2("".concat(e3, " '").concat(t3, "' was not loaded, try using full build of exifr."));
        }
        var N2 = function(e3) {
          a2(i3, e3);
          var n3 = d2(i3);
          function i3(e4) {
            var r3;
            return t2(this, i3), (r3 = n3.call(this)).kind = e4, r3;
          }
          return r2(i3, [{
            key: "get",
            value: function(e4, t3) {
              return this.has(e4) || R(this.kind, e4), t3 && (e4 in t3 || function(e5, t4) {
                L2("Unknown ".concat(e5, " '").concat(t4, "'."));
              }(this.kind, e4), t3[e4].enabled || R(this.kind, e4)), v2(s2(i3.prototype), "get", this).call(this, e4);
            }
          }, {
            key: "keyList",
            value: function() {
        ...
        }(c2(P2)), M2 = new N2("file parser"), W = new N2("segment parser"), K = new N2("file reader");
        function H2(e3) {
          return function() {
        ...
        function X(e3, t3, n3) {
          return n3 ? t3 ? t3(e3) : e3 : (e3 && e3.then || (e3 = Promise.resolve(e3)), t3 ? e3.then(t3) : e3);
        }
        var Y = H2(function(e3) {
          return new Promise(function(t3, n3) {
            var r3 = new FileReader();
            r3.onloadend = function() {
              return t3(r3.result || new ArrayBuffer());
            }, r3.onerror = n3, r3.readAsArrayBuffer(e3);
          });
        }), G = H2(function(e3) {
          return w2(e3).then(function(e4) {
            return e4.arrayBuffer();
          });
        }), J = H2(function(e3, t3) {
          return X(t3(e3), function(e4) {
            return new D2(e4);
          });
        }), q2 = H2(function(e3, t3, n3) {
          var r3 = new (K.get(n3))(e3, t3);
          return X(r3.read(), function() {
            return r3;
          });
        }), Q = H2(function(e3, t3, n3, r3) {
          return K.has(n3) ? q2(e3, t3, n3) : r3 ? J(e3, r3) : (L2("Parser ".concat(n3, " is not loaded")), X());
        }), Z = "Invalid input argument";
        function $2(e3, t3) {
          return (n3 = e3).startsWith("data:") || n3.length > 1e4 ? q2(e3, t3, "base64") : x2 ? Q(e3, t3, "url", G) : B2 ? q2(e3, t3, "fs") : void L2(Z);
          var n3;
        }
        var ee = function(e3) {
          a2(i3, e3);
          var n3 = d2(i3);
          function i3() {
            return t2(this, i3), n3.apply(this, arguments);
          }
          return r2(i3, [{
            key: "tagKeys",
            get: function() {
              return this.allKeys || (this.allKeys = m2(this.keys())), this.allKeys;
            }
          }, {
            key: "tagValues",
            get: function() {
              return this.allValues || (this.allValues = m2(this.values())), this.allValues;
            }
          }]), i3;
        }(c2(P2));
        function te(e3, t3, n3) {
          var r3 = new ee(), i3 = n3;
          Array.isArray(i3) || (typeof i3.entries == "function" && (i3 = i3.entries()), i3 = m2(i3));
          for (var a3 = 0; a3 < i3.length; a3++) {
            var s3 = i3[a3], u3 = s3[0], o3 = s3[1];
            r3.set(u3, o3);
          }
          if (Array.isArray(t3)) {
            var f3 = t3;
            Array.isArray(f3) || (typeof f3.entries == "function" && (f3 = f3.entries()), f3 = m2(f3));
            for (var c3 = 0; c3 < f3.length; c3++) {
              var h3 = f3[c3];
              e3.set(h3, r3);
            }
          } else
        ...
        function ne(e3, t3, n3) {
          var r3, i3 = e3.get(t3), a3 = n3;
          Array.isArray(a3) || (typeof a3.entries == "function" && (a3 = a3.entries()), a3 = m2(a3));
          for (var s3 = 0; s3 < a3.length; s3++)
            r3 = a3[s3], i3.set(r3[0], r3[1]);
        }
        var re = S2(), ie = S2(), ae = S2(), se = 37500, ue = 37510, oe = 33723, fe = 34675, ce = 34665, he = 34853, le = 40965, de = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"], ve = ["jfif", "xmp", "icc", "iptc", "ihdr"], pe = ["tiff"].concat(ve), ye = ["ifd0", "ifd1", "exif", "gps", "interop"], ge = [].concat(pe, ye), ke = ["makerNote", "userComment"], me = ["translateKeys", "translateValues", "reviveValues", "multiSegment"], be = [].concat(me, ["sanitize", "mergeOutput", "silentErrors"]), Ae = function() {
          ...
          a2(s3, e3);
          var n3 = d2(s3);
          function s3(e4, r3, a3, u3) {
            var o3;
            if (t2(this, s3), i2(h2(o3 = n3.call(this)), "enabled", false), i2(h2(o3), "skip", O2()), i2(h2(o3), "pick", O2()), i2(h2(o3), "deps", O2()), i2(h2(o3), "translateKeys", false), i2(h2(o3), "translateValues", false), i2(h2(o3), "reviveValues", false), o3.key = e4, o3.enabled = r3, o3.parse = o3.enabled, o3.applyInheritables(u3), o3.canBeFiltered = ye.includes(e4), o3.canBeFiltered && (o3.dict = re.get(e4)), a3 !== void 0)
              if (Array.isArray(a3))
                o3.parse = o3.enabled = true, o3.canBeFiltered && a3.length > 0 && o3.translateTagSet(a3, o3.pick);
              else if (typeof a3 == "object") {
                if (o3.enabled = true, o3.parse = a3.parse !== false, o3.canBeFiltered) {
                  var f3 = a3.pick, c3 = a3.skip;
                  f3 && f3.length > 0 && o3.translateTagSet(f3, o3.pick), c3 && c3.length > 0 && o3.translateTagSet(c3, o3.skip);
                }
                o3.applyInheritables(a3);
              } else
                a3 === true || a3 === false ? o3.parse = o3.enabled = a3 : L2("Invalid options argument: ".concat(a3));
            return o3;
          }
          return r2(s3, [{
            key: "needed",
            ...
            value: function(e4) {
              var t3, n4, r3 = me;
              Array.isArray(r3) || (typeof r3.entries == "function" && (r3 = r3.entries()), r3 = m2(r3));
              for (var i3 = 0; i3 < r3.length; i3++)
                (n4 = e4[t3 = r3[i3]]) !== void 0 && (this[t3] = n4);
            }
          }, {
            key: "translateTagSet",
            value: function(e4, t3) {
              if (this.dict) {
                var n4, r3, i3 = this.dict, a3 = i3.tagKeys, s4 = i3.tagValues, u3 = e4;
                Array.isArray(u3) || (typeof u3.entries == "function" && (u3 = u3.entries()), u3 = m2(u3));
                for (var o3 = 0; o3 < u3.length; o3++)
                  typeof (n4 = u3[o3]) == "string" ? ((r3 = s4.indexOf(n4)) === -1 && (r3 = a3.indexOf(Number(n4))), r3 !== -1 && t3.add(Number(a3[r3]))) : t3.add(n4);
              } else {
                var f3 = e4;
                Array.isArray(f3) || (typeof f3.entries == "function" && (f3 = f3.entries()), f3 = m2(f3));
                for (var c3 = 0; c3 < f3.length; c3++) {
          ...
          chunkSize: 65536,
          chunkLimit: 5
        }, Se = S2(), Pe = function(e3) {
          a2(i3, e3);
          var n3 = d2(i3);
          function i3(e4) {
            var r3;
            return t2(this, i3), r3 = n3.call(this), e4 === true ? r3.setupFromTrue() : e4 === void 0 ? r3.setupFromUndefined() : Array.isArray(e4) ? r3.setupFromArray(e4) : typeof e4 == "object" ? r3.setupFromObject(e4) : L2("Invalid options argument ".concat(e4)), r3.firstChunkSize === void 0 && (r3.firstChunkSize = x2 ? r3.firstChunkSizeBrowser : r3.firstChunkSizeNode), r3.mergeOutput && (r3.ifd1.enabled = false), r3.filterNestedSegmentTags(), r3.traverseTiffDependencyTree(), r3.checkLoadedPlugins(), r3;
          }
          return r2(i3, [{
            key: "setupFromUndefined",
            value: function() {
              var e4, t3 = de;
              Array.isArray(t3) || (typeof t3.entries == "function" && (t3 = t3.entries()), t3 = m2(t3));
              ...
              Array.isArray(u3) || (typeof u3.entries == "function" && (u3 = u3.entries()), u3 = m2(u3));
              for (var o3 = 0; o3 < u3.length; o3++)
                this[e4 = u3[o3]] = new we(e4, Oe[e4], void 0, this);
            }
          }, {
            key: "setupFromTrue",
            value: function() {
              ...
              Array.isArray(u3) || (typeof u3.entries == "function" && (u3 = u3.entries()), u3 = m2(u3));
              for (var o3 = 0; o3 < u3.length; o3++)
                this[e4 = u3[o3]] = new we(e4, true, void 0, this);
            }
          }, {
            key: "setupFromArray",
            value: function(e4) {
              var t3, n4 = de;
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m2(n4));
              for (var r3 = 0; r3 < n4.length; r3++)
                this[t3 = n4[r3]] = Oe[t3];
              var i4 = be;
              Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m2(i4));
              for (var a3 = 0; a3 < i4.length; a3++)
                this[t3 = i4[a3]] = Oe[t3];
              var s3 = ke;
              Array.isArray(s3) || (typeof s3.entries == "function" && (s3 = s3.entries()), s3 = m2(s3));
              for (var u3 = 0; u3 < s3.length; u3++)
                this[t3 = s3[u3]] = Oe[t3];
              var o3 = ge;
              Array.isArray(o3) || (typeof o3.entries == "function" && (o3 = o3.entries()), o3 = m2(o3));
              for (var f3 = 0; f3 < o3.length; f3++)
                this[t3 = o3[f3]] = new we(t3, false, void 0, this);
              this.setupGlobalFilters(e4, void 0, ye);
            }
          }, {
            key: "setupFromObject",
            value: function(e4) {
              var t3;
              ye.ifd0 = ye.ifd0 || ye.image, ye.ifd1 = ye.ifd1 || ye.thumbnail, g2(this, e4);
              var n4 = de;
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m2(n4));
              for (var r3 = 0; r3 < n4.length; r3++)
                this[t3 = n4[r3]] = xe(e4[t3], Oe[t3]);
              var i4 = be;
              Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m2(i4));
              for (var a3 = 0; a3 < i4.length; a3++)
                this[t3 = i4[a3]] = xe(e4[t3], Oe[t3]);
              var s3 = ke;
              Array.isArray(s3) || (typeof s3.entries == "function" && (s3 = s3.entries()), s3 = m2(s3));
              for (var u3 = 0; u3 < s3.length; u3++)
                this[t3 = s3[u3]] = xe(e4[t3], Oe[t3]);
              var o3 = pe;
              Array.isArray(o3) || (typeof o3.entries == "function" && (o3 = o3.entries()), o3 = m2(o3));
              for (var f3 = 0; f3 < o3.length; f3++)
                this[t3 = o3[f3]] = new we(t3, Oe[t3], e4[t3], this);
              var c3 = ye;
              Array.isArray(c3) || (typeof c3.entries == "function" && (c3 = c3.entries()), c3 = m2(c3));
              for (var h3 = 0; h3 < c3.length; h3++)
                this[t3 = c3[h3]] = new we(t3, Oe[t3], e4[t3], this.tiff);
              this.setupGlobalFilters(e4.pick, e4.skip, ye, ge), e4.tiff === true ? this.batchEnableWithBool(ye, true) : e4.tiff === false ? this.batchEnableWithUserValue(ye, e4) : Array.isArray(e4.tiff) ? this.setupGlobalFilters(e4.tiff, void 0, ye) : typeof e4.tiff == "object" && this.setupGlobalFilters(e4.tiff.pick, e4.tiff.skip, ye);
            }
          }, {
            ...
            value: function(e4, t3) {
              ...
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m2(n4));
              for (var r3 = 0; r3 < n4.length; r3++) {
                var i4 = n4[r3], a3 = t3[i4];
                this[i4].enabled = a3 !== false && a3 !== void 0;
              }
            }
          }, {
            key: "setupGlobalFilters",
            value: function(e4, t3, n4) {
              var r3 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : n4;
              if (e4 && e4.length) {
                var i4 = r3;
                Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m2(i4));
                for (var a3 = 0; a3 < i4.length; a3++) {
                ...
                var u3 = Ue(e4, n4), o3 = u3;
                Array.isArray(o3) || (typeof o3.entries == "function" && (o3 = o3.entries()), o3 = m2(o3));
                for (var f3 = 0; f3 < o3.length; f3++) {
                  var c3 = o3[f3], h3 = c3[0], l3 = c3[1];
                  Ce(this[h3].pick, l3), this[h3].enabled = true;
                }
              } else if (t3 && t3.length) {
                var d3 = Ue(t3, n4), v3 = d3;
                Array.isArray(v3) || (typeof v3.entries == "function" && (v3 = v3.entries()), v3 = m2(v3));
                for (var p3 = 0; p3 < v3.length; p3++) {
                  var y3 = v3[p3], g3 = y3[0], k3 = y3[1];
                  Ce(this[g3].skip, k3);
                }
              }
            }
            ...
            value: function() {
              var e4 = this.ifd0, t3 = this.exif, n4 = this.xmp, r3 = this.iptc, i4 = this.icc;
              this.makerNote ? t3.deps.add(se) : t3.skip.add(se), this.userComment ? t3.deps.add(ue) : t3.skip.add(ue), n4.enabled || e4.skip.add(700), r3.enabled || e4.skip.add(oe), i4.enabled || e4.skip.add(fe);
            }
          }, {
            key: "traverseTiffDependencyTree",
            value: function() {
              var e4 = this, t3 = this.ifd0, n4 = this.exif, r3 = this.gps;
              this.interop.needed && (n4.deps.add(le), t3.deps.add(le)), n4.needed && t3.deps.add(ce), r3.needed && t3.deps.add(he), this.tiff.enabled = ye.some(function(t4) {
                return e4[t4].enabled === true;
              }) || this.makerNote || this.userComment;
              var i4 = ye;
              Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m2(i4));
              for (var a3 = 0; a3 < i4.length; a3++) {
                this[i4[a3]].finalizeFilters();
              }
            }
          }, {
            key: "onlyTiff",
            get: function() {
              var e4 = this;
              return !ve.map(function(t3) {
                return e4[t3].enabled;
              }).some(function(e5) {
                return e5 === true;
              }) && this.tiff.enabled;
            }
            ...
            value: function() {
              var e4 = pe;
              Array.isArray(e4) || (typeof e4.entries == "function" && (e4 = e4.entries()), e4 = m2(e4));
            ...
            value: function(e4) {
              var t3 = Se.get(e4);
              return t3 !== void 0 || (t3 = new this(e4), Se.set(e4, t3)), t3;
            }
          }]), i3;
        }(Ae);
        function Ue(e3, t3) {
          var n3, r3, i3, a3 = [], s3 = t3;
          Array.isArray(s3) || (typeof s3.entries == "function" && (s3 = s3.entries()), s3 = m2(s3));
          for (var u3 = 0; u3 < s3.length; u3++) {
            r3 = s3[u3], n3 = [];
            var o3 = re.get(r3);
            Array.isArray(o3) || (typeof o3.entries == "function" && (o3 = o3.entries()), o3 = m2(o3));
            for (var f3 = 0; f3 < o3.length; f3++)
              i3 = o3[f3], (e3.includes(i3[0]) || e3.includes(i3[1])) && n3.push(i3[0]);
            n3.length && a3.push([r3, n3]);
          }
          return a3;
        }
        function xe(e3, t3) {
        ...
        function Ce(e3, t3) {
          var n3 = t3;
          Array.isArray(n3) || (typeof n3.entries == "function" && (n3 = n3.entries()), n3 = m2(n3));
          for (var r3 = 0; r3 < n3.length; r3++) {
            var i3 = n3[r3];
            e3.add(i3);
          }
        ...
        function _e(e3, t3) {
          if (!t3)
            return e3 && e3.then ? e3.then(je) : Promise.resolve();
        }
        function Ve(e3, t3) {
          var n3 = e3();
          return n3 && n3.then ? n3.then(t3) : t3(n3);
        }
        i2(Pe, "default", Oe);
        var Ie = function() {
          function e3(n3) {
            t2(this, e3), i2(this, "parsers", {}), this.options = Pe.useCached(n3);
          }
          return r2(e3, [{
            key: "setup",
            value: function() {
              if (!this.fileParser) {
                var e4 = this.file, t3 = e4.getUint16(0), n3 = M2;
                Array.isArray(n3) || (typeof n3.entries == "function" && (n3 = n3.entries()), n3 = m2(n3));
                for (var r3 = 0; r3 < n3.length; r3++) {
                  var i3 = n3[r3], a3 = i3[0], s3 = i3[1];
                  if (s3.canHandle(e4, t3))
                    return this.fileParser = new s3(this.options, this.file, this.parsers), e4[a3] = true;
                }
            ...
            value: function(e4) {
              try {
                var t3 = this;
                return Be(function(e5, t4) {
                  return typeof e5 == "string" ? $2(e5, t4) : x2 && !C2 && e5 instanceof HTMLImageElement ? $2(e5.src, t4) : e5 instanceof Uint8Array || e5 instanceof ArrayBuffer || e5 instanceof DataView ? new D2(e5) : x2 && e5 instanceof Blob ? Q(e5, t4, "blob", Y) : void L2(Z);
                }(e4, t3.options), function(e5) {
                  t3.file = e5;
                });
              } catch (e5) {
            ...
            value: function() {
              try {
                ...
                var t3 = {}, n3 = [];
                return Ve(function() {
                  return e4.options.silentErrors ? Be(e4.doParse(t3, n3).catch(function(e5) {
                    return n3.push(e5);
                  }), function() {
                    n3.push.apply(n3, e4.fileParser.errors);
                  }) : _e(e4.doParse(t3, n3));
                }, function() {
                  return e4.file.close && e4.file.close(), e4.options.silentErrors && n3.length > 0 && (t3.errors = n3), I2(r3 = t3) ? void 0 : r3;
                  var r3;
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            value: function(e4, t3) {
              try {
                ...
                return Be(n3.fileParser.parse(), function() {
                  var r3, i3 = p2(n3.parsers).map((r3 = function(t4) {
                    return Be(t4.parse(), function(n4) {
                      t4.assignToOutput(e4, n4);
                    });
                  }, function() {
                    for (var e5 = [], t4 = 0; t4 < arguments.length; t4++)
                      e5[t4] = arguments[t4];
                    try {
                      return Promise.resolve(r3.apply(this, e5));
                    } catch (e6) {
                  ...
                  if (n3.options.silentErrors) {
                    ...
                    i3 = i3.map(function(e5) {
                      return e5.catch(a3);
                    });
                  }
                  return _e(Promise.all(i3));
                });
              } catch (e5) {
                return Promise.reject(e5);
              }
            ...
            value: function() {
              try {
                var e4 = this;
                e4.setup();
                var t3, n3 = e4.options, r3 = e4.file, i3 = W.get("tiff", n3);
                return Ve(function() {
                  if (!r3.tiff)
                    return function(e5) {
                      var t4 = e5();
                      ...
                      if (r3.jpeg)
                        return Be(e4.fileParser.getOrFindSegment("tiff"), function(e5) {
                          t3 = e5;
                        });
                    });
                  t3 = {
                  ...
                  if (t3 !== void 0)
                    return Be(e4.fileParser.ensureSegmentChunk(t3), function(t4) {
                      return Be((e4.parsers.tiff = new i3(t4, n3, r3)).extractThumbnail(), function(e5) {
                        return r3.close && r3.close(), e5;
                      });
                    });
                });
              } catch (e5) {
        ...
        var Le, Te = (Le = function(e3, t3) {
          var n3, r3, i3, a3 = new Ie(t3);
          return n3 = a3.read(e3), r3 = function() {
            return a3.parse();
          }, i3 ? r3 ? r3(n3) : n3 : (n3 && n3.then || (n3 = Promise.resolve(n3)), r3 ? n3.then(r3) : n3);
        }, function() {
          for (var e3 = [], t3 = 0; t3 < arguments.length; t3++)
            e3[t3] = arguments[t3];
          try {
            return Promise.resolve(Le.apply(this, e3));
          } catch (e4) {
            return Promise.reject(e4);
          }
        }), ze = Object.freeze({
        ...
        var Ee = function() {
          function e3(n3, r3, a3) {
            var s3 = this;
            t2(this, e3), i2(this, "errors", []), i2(this, "ensureSegmentChunk", function(e4) {
              return function() {
                for (var t3 = [], n4 = 0; n4 < arguments.length; n4++)
                  t3[n4] = arguments[n4];
                try {
                  return Promise.resolve(e4.apply(this, t3));
                } catch (e5) {
                  return Promise.reject(e5);
                }
              };
            }(function(e4) {
              var t3, n4, r4, i3 = e4.start, a4 = e4.size || 65536;
              return t3 = function() {
                if (s3.file.chunked)
                  return function(e5) {
                    var t4 = e5();
                    ...
                    if (!s3.file.available(i3, a4))
                      return function(e5) {
                        ...
                        return n5 && n5.then ? n5.then(void 0, t4) : n5;
                      }(function() {
                        return t4 = s3.file.readChunk(i3, a4), n5 = function(t5) {
                          e4.chunk = t5;
                        }, r5 ? n5 ? n5(t4) : t4 : (t4 && t4.then || (t4 = Promise.resolve(t4)), n5 ? t4.then(n5) : t4);
                        var t4, n5, r5;
                      }, function(t4) {
                        L2("Couldn't read segment: ".concat(JSON.stringify(e4), ". ").concat(t4.message));
                      }));
                    e4.chunk = s3.file.subarray(i3, a4);
                  });
                s3.file.byteLength > i3 + a4 ? e4.chunk = s3.file.subarray(i3, a4) : e4.size === void 0 ? e4.chunk = s3.file.subarray(i3) : L2("Segment unreachable: " + JSON.stringify(e4));
              }, n4 = function() {
                return e4.chunk;
              }, (r4 = t3()) && r4.then ? r4.then(n4) : n4(r4);
            })), this.extendOptions && this.extendOptions(n3), this.options = n3, this.file = r3, this.parsers = a3;
          }
          return r2(e3, [{
            key: "injectSegment",
            value: function(e4, t3) {
              this.options[e4].enabled && this.createParser(e4, t3);
            }
          }, {
            key: "createParser",
            value: function(e4, t3) {
              var n3 = new (W.get(e4))(t3, this.options, this.file);
              return this.parsers[e4] = n3;
            }
          }, {
            key: "createParsers",
            value: function(e4) {
              ...
              Array.isArray(t3) || (typeof t3.entries == "function" && (t3 = t3.entries()), t3 = m2(t3));
              for (var n3 = 0; n3 < t3.length; n3++) {
                var r3 = t3[n3], i3 = r3.type, a3 = r3.chunk, s3 = this.options[i3];
                if (s3 && s3.enabled) {
                  var u3 = this.parsers[i3];
                  u3 && u3.append || u3 || this.createParser(i3, a3);
                }
              }
            }
          }, {
            ...
            value: function(e4) {
              try {
                var t3 = e4.map(this.ensureSegmentChunk);
                return function(e5, t4) {
                  if (!t4)
                    return e5 && e5.then ? e5.then(Fe) : Promise.resolve();
                }(Promise.all(t3));
              } catch (e5) {
                return Promise.reject(e5);
              }
          ...
          function e3(n3) {
            var r3 = this, a3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, s3 = arguments.length > 2 ? arguments[2] : void 0;
            t2(this, e3), i2(this, "errors", []), i2(this, "raw", S2()), i2(this, "handleError", function(e4) {
              if (!r3.options.silentErrors)
                throw e4;
              r3.errors.push(e4.message);
            }), this.chunk = this.normalizeInput(n3), this.file = s3, this.type = this.constructor.type, this.globalOptions = this.options = a3, this.localOptions = a3[this.type], this.canTranslate = this.localOptions && this.localOptions.translate;
          }
          return r2(e3, [{
            key: "normalizeInput",
            value: function(e4) {
              return e4 instanceof D2 ? e4 : new D2(e4);
            }
          }, {
            key: "translate",
            value: function() {
            ...
            key: "output",
            get: function() {
              return this.translated ? this.translated : this.raw ? k2(this.raw) : void 0;
            }
          }, {
            key: "translateBlock",
            value: function(e4, t3) {
              var n3 = ae.get(t3), r3 = ie.get(t3), i3 = re.get(t3), a3 = this.options[t3], s3 = a3.reviveValues && !!n3, u3 = a3.translateValues && !!r3, o3 = a3.translateKeys && !!i3, f3 = {}, c3 = e4;
              Array.isArray(c3) || (typeof c3.entries == "function" && (c3 = c3.entries()), c3 = m2(c3));
              for (var h3 = 0; h3 < c3.length; h3++) {
                var l3 = c3[h3], d3 = l3[0], v3 = l3[1];
                s3 && n3.has(d3) ? v3 = n3.get(d3)(v3) : u3 && r3.has(d3) && (v3 = this.translateValue(v3, r3.get(d3))), o3 && i3.has(d3) && (d3 = i3.get(d3) || d3), f3[d3] = v3;
              }
              return f3;
            }
          }, {
            key: "translateValue",
            value: function(e4, t3) {
              return t3[e4] || t3.DEFAULT || e4;
            }
          }, {
            key: "assignToOutput",
            value: function(e4, t3) {
              this.assignObjectToOutput(e4, this.constructor.type, t3);
            }
          }, {
            ...
            value: function(e4, t3, n3) {
              if (this.globalOptions.mergeOutput)
                return g2(e4, n3);
              e4[t3] ? g2(e4[t3], n3) : e4[t3] = n3;
            }
          }], [{
            key: "findPosition",
            value: function(e4, t3) {
              var n3 = e4.getUint16(t3 + 2) + 2, r3 = typeof this.headerLength == "function" ? this.headerLength(e4, t3, n3) : this.headerLength, i3 = t3 + r3, a3 = n3 - r3;
              return {
                offset: t3,
                length: n3,
                headerLength: r3,
            ...
            key: "parse",
            value: function(e4) {
              var t3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n3 = new Pe(i2({}, this.type, t3)), r3 = new this(e4, n3);
              return r3.parse();
            }
          }]), e3;
        }();
        ...
        i2(De, "headerLength", 4), i2(De, "type", void 0), i2(De, "multiSegment", false), i2(De, "canHandle", function() {
          return false;
        });
        function Ne() {
        }
        function Me(e3, t3) {
          if (!t3)
            return e3 && e3.then ? e3.then(Ne) : Promise.resolve();
        }
        function We(e3) {
          var t3 = e3();
          if (t3 && t3.then)
        ...
        function He(e3, t3, n3) {
          if (!e3.s) {
            if (n3 instanceof Xe) {
              if (!n3.s)
                return void (n3.o = He.bind(null, e3, t3));
              1 & t3 && (t3 = n3.s), n3 = n3.v;
            }
            if (n3 && n3.then)
              return void n3.then(He.bind(null, e3, t3), He.bind(null, e3, 2));
            e3.s = t3, e3.v = n3;
            var r3 = e3.o;
            r3 && r3(e3);
          }
        ...
        var Xe = function() {
          ...
          return e3.prototype.then = function(t3, n3) {
            var r3 = new e3(), i3 = this.s;
            if (i3) {
              var a3 = 1 & i3 ? t3 : n3;
              if (a3) {
                try {
            ...
            return this.o = function(e4) {
              try {
                var i4 = e4.v;
                1 & e4.s ? He(r3, 1, t3 ? t3(i4) : i4) : n3 ? He(r3, 1, n3(i4)) : He(r3, 2, i4);
              } catch (e5) {
                He(r3, 2, e5);
              }
            }, r3;
        ...
        function Ye(e3) {
          return e3 instanceof Xe && 1 & e3.s;
        }
        function Ge(e3, t3, n3) {
          ...
          var u3 = new Xe(), o3 = He.bind(null, u3, 2);
          return (r3 === 0 ? i3.then(c3) : r3 === 1 ? a3.then(f3) : s3.then(h3)).then(void 0, o3), u3;
          function f3(r4) {
            a3 = r4;
            do {
              if (t3 && (s3 = t3()) && s3.then && !Ye(s3))
                return void s3.then(h3).then(void 0, o3);
              if (!(i3 = e3()) || Ye(i3) && !i3.v)
                return void He(u3, 1, a3);
              if (i3.then)
                return void i3.then(c3).then(void 0, o3);
              Ye(a3 = n3()) && (a3 = a3.v);
            } while (!a3 || !a3.then);
            a3.then(f3).then(void 0, o3);
          }
          function c3(e4) {
            e4 ? (a3 = n3()) && a3.then ? a3.then(f3).then(void 0, o3) : f3(a3) : He(u3, 1, a3);
          }
          function h3() {
            (i3 = e3()) ? i3.then ? i3.then(c3).then(void 0, o3) : c3(i3) : He(u3, 1, a3);
          }
        }
        function Je(e3) {
        ...
        function Qe(e3, t3, n3) {
          ...
          Array.isArray(r3) || (typeof r3.entries == "function" && (r3 = r3.entries()), r3 = m2(r3));
          for (var i3 = 0; i3 < r3.length; i3++) {
            var a3 = r3[i3], s3 = a3[0];
            if (a3[1].canHandle(e3, t3, n3))
              return s3;
          }
        }
        var Ze = function(e3) {
          ...
          function s3() {
            var e4;
            t2(this, s3);
            for (var r3 = arguments.length, a3 = new Array(r3), u3 = 0; u3 < r3; u3++)
              a3[u3] = arguments[u3];
            return i2(h2(e4 = n3.call.apply(n3, [this].concat(a3))), "appSegments", []), i2(h2(e4), "jpegSegments", []), i2(h2(e4), "unknownSegments", []), e4;
          }
          return r2(s3, [{
            key: "parse",
            value: function() {
              try {
                var e4 = this;
                return Re(e4.findAppSegments(), function() {
                  return Re(e4.readSegments(e4.appSegments), function() {
                    e4.mergeMultiSegments(), e4.createParsers(e4.mergedAppSegments || e4.appSegments);
                  });
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            value: function(e4) {
              var t3 = this;
              e4 === true ? (this.findAll = true, this.wanted = O2(W.keyList())) : (e4 = e4 === void 0 ? W.keyList().filter(function(e5) {
                return t3.options[e5].enabled;
              }) : e4.filter(function(e5) {
                return t3.options[e5].enabled && W.has(e5);
              }), this.findAll = false, this.remaining = O2(e4), this.wanted = O2(e4)), this.unfinishedMultiSegment = false;
            }
          }, {
            key: "findAppSegments",
            value: function() {
              var e4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t3 = arguments.length > 1 ? arguments[1] : void 0;
              try {
                var n4 = this;
                n4.setupSegmentFinderArgs(t3);
                var r3 = n4.file, i3 = n4.findAll, a3 = n4.wanted, s4 = n4.remaining;
                return Ke(function() {
                  if (!i3 && n4.file.chunked)
                    return i3 = m2(a3).some(function(e5) {
                      var t4 = W.get(e5), r4 = n4.options[e5];
                      return t4.multiSegment && r4.multiSegment;
                    }), We(function() {
                      if (i3)
                  ...
                  var t4 = false;
                  if (e4 = n4.findAppSegmentsInRange(e4, r3.byteLength), !n4.options.onlyTiff)
                    return function() {
                      if (r3.chunked) {
                        var i4 = false;
                        return Ge(function() {
                          return !t4 && s4.size > 0 && !i4 && (!!r3.canReadNextChunk || !!n4.unfinishedMultiSegment);
                        }, void 0, function() {
                          var a4 = r3.nextChunkOffset, s5 = n4.appSegments.some(function(e5) {
                            return !n4.file.available(e5.offset || e5.start, e5.length || e5.size);
                          });
                          return Ke(function() {
                            return e4 > a4 && !s5 ? Re(r3.readNextChunk(e4), function(e5) {
                              i4 = !e5;
                            }) : Re(r3.readNextChunk(a4), function(e5) {
                              i4 = !e5;
                            });
                          }, function() {
                            (e4 = n4.findAppSegmentsInRange(e4, r3.byteLength)) === void 0 && (t4 = true);
                          });
                        });
                      }
                    }();
            ...
            value: function(e4, t3) {
              t3 -= 2;
              for (var n4, r3, i3, a3, s4, u3, o3 = this.file, f3 = this.findAll, c3 = this.wanted, h3 = this.remaining, l3 = this.options; e4 < t3; e4++)
                if (o3.getUint8(e4) === 255) {
                  if (qe(n4 = o3.getUint8(e4 + 1))) {
                    if (r3 = o3.getUint16(e4 + 2), (i3 = Qe(o3, e4, r3)) && c3.has(i3) && (s4 = (a3 = W.get(i3)).findPosition(o3, e4), u3 = l3[i3], s4.type = i3, this.appSegments.push(s4), !f3 && (a3.multiSegment && u3.multiSegment ? (this.unfinishedMultiSegment = s4.chunkNumber < s4.chunkCount, this.unfinishedMultiSegment || h3.delete(i3)) : h3.delete(i3), h3.size === 0)))
                      break;
                    l3.recordUnknownSegments && ((s4 = De.findPosition(o3, e4)).marker = n4, this.unknownSegments.push(s4)), e4 += r3 + 1;
                  } else if (Je(n4)) {
                    if (r3 = o3.getUint16(e4 + 2), n4 === 218 && l3.stopAfterSos !== false)
                      return;
                    l3.recordJpegSegments && this.jpegSegments.push({
                      offset: e4,
                      length: r3,
                      marker: n4
                    }), e4 += r3 + 1;
            ...
            value: function() {
              var e4 = this;
              if (this.appSegments.some(function(e5) {
                return e5.multiSegment;
              })) {
                var t3 = function(e5, t4) {
                  for (var n4, r3, i3, a3 = S2(), s4 = 0; s4 < e5.length; s4++)
                    r3 = (n4 = e5[s4])[t4], a3.has(r3) ? i3 = a3.get(r3) : a3.set(r3, i3 = []), i3.push(n4);
                  return m2(a3);
                }(this.appSegments, "type");
                this.mergedAppSegments = t3.map(function(t4) {
                  var n4 = t4[0], r3 = t4[1], i3 = W.get(n4, e4.options);
                  return i3.handleMultiSegments ? {
                    type: n4,
                    chunk: i3.handleMultiSegments(r3)
                  } : r3[0];
                });
              }
            }
            ...
            key: "getSegment",
            value: function(e4) {
              return this.appSegments.find(function(t3) {
                return t3.type === e4;
              });
            }
          }, {
            ...
            value: function(e4) {
              try {
                var t3 = this, n4 = t3.getSegment(e4);
                return Ke(function() {
                  if (n4 === void 0)
                    return Re(t3.findAppSegments(0, [e4]), function() {
                      n4 = t3.getSegment(e4);
                    });
                }, function() {
                  return n4;
        ...
        i2(Ze, "type", "jpeg"), M2.set("jpeg", Ze);
        function et(e3, t3) {
          if (!t3)
            return e3 && e3.then ? e3.then($e) : Promise.resolve();
        }
        function tt(e3, t3) {
          var n3 = e3();
          return n3 && n3.then ? n3.then(t3) : t3(n3);
        ...
        var rt = function(e3) {
          ...
          return r2(i3, [{
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  if (t3.ifd0.enabled)
                    return et(e4.parseIfd0Block());
                }, function() {
                  return tt(function() {
                    if (t3.exif.enabled)
                      return et(e4.safeParse("parseExifBlock"));
                  }, function() {
                    return tt(function() {
                      if (t3.gps.enabled)
                        return et(e4.safeParse("parseGpsBlock"));
                    }, function() {
                      return tt(function() {
                        if (t3.interop.enabled)
                          return et(e4.safeParse("parseInteropBlock"));
                      }, function() {
                        return tt(function() {
                          if (t3.ifd1.enabled)
                            return et(e4.safeParse("parseThumbnailBlock"));
                        }, function() {
                          return e4.createOutput();
                        });
                      });
                    });
                  });
            ...
            value: function() {
              if (this.ifd1Offset === void 0) {
                this.findIfd0Offset();
                var e4 = this.chunk.getUint16(this.ifd0Offset), t3 = this.ifd0Offset + 2 + 12 * e4;
            ...
            value: function(e4, t3) {
              var n4 = S2();
              return this[t3] = n4, this.parseTags(e4, t3, n4), n4;
            }
          }, {
            key: "parseIfd0Block",
            value: function() {
              try {
                ...
                if (e4.ifd0)
                  return;
                var t3 = e4.file;
                return e4.findIfd0Offset(), e4.ifd0Offset < 8 && L2("Malformed EXIF data"), !t3.chunked && e4.ifd0Offset > t3.byteLength && L2("IFD0 offset points to outside of file.\nthis.ifd0Offset: ".concat(e4.ifd0Offset, ", file.byteLength: ").concat(t3.byteLength)), tt(function() {
                  if (t3.tiff)
                    return et(t3.ensureChunk(e4.ifd0Offset, T2(e4.options)));
                }, function() {
                  var t4 = e4.parseBlock(e4.ifd0Offset, "ifd0");
                  if (t4.size !== 0)
                    return e4.exifOffset = t4.get(ce), e4.interopOffset = t4.get(le), e4.gpsOffset = t4.get(he), e4.xmp = t4.get(700), e4.iptc = t4.get(oe), e4.icc = t4.get(fe), e4.options.sanitize && (t4.delete(ce), t4.delete(le), t4.delete(he), t4.delete(700), t4.delete(oe), t4.delete(fe)), t4;
                });
              } catch (e5) {
                return Promise.reject(e5);
              }
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  if (e4.exifOffset !== void 0)
                    return tt(function() {
                      if (e4.file.tiff)
                        return et(e4.file.ensureChunk(e4.exifOffset, T2(e4.options)));
                    }, function() {
                      var t3 = e4.parseBlock(e4.exifOffset, "exif");
                      return e4.interopOffset || (e4.interopOffset = t3.get(le)), e4.makerNote = t3.get(se), e4.userComment = t3.get(ue), e4.options.sanitize && (t3.delete(le), t3.delete(se), t3.delete(ue)), e4.unpack(t3, 41728), e4.unpack(t3, 41729), t3;
                    });
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  if (e4.gpsOffset !== void 0) {
                    var t3 = e4.parseBlock(e4.gpsOffset, "gps");
                    return t3 && t3.has(2) && t3.has(4) && (t3.set("latitude", it.apply(void 0, t3.get(2).concat([t3.get(1)]))), t3.set("longitude", it.apply(void 0, t3.get(4).concat([t3.get(3)])))), t3;
                  }
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  return tt(function() {
                    if (e4.interopOffset === void 0 && !e4.exif)
                      return et(e4.parseExifBlock());
                  }, function() {
                    if (e4.interopOffset !== void 0)
                      return e4.parseBlock(e4.interopOffset, "interop");
                  });
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            value: function() {
              ...
              try {
                var t3 = this;
                if (t3.ifd1 || t3.ifd1Parsed)
                  return;
                if (t3.options.mergeOutput && !e4)
                  return;
                return t3.findIfd1Offset(), t3.ifd1Offset > 0 && (t3.parseBlock(t3.ifd1Offset, "ifd1"), t3.ifd1Parsed = true), t3.ifd1;
              } catch (e5) {
                return Promise.reject(e5);
              }
            }
            ...
            value: function() {
              try {
                var e4 = this;
                return e4.headerParsed || e4.parseHeader(), tt(function() {
                  if (!e4.ifd1Parsed)
                    return et(e4.parseThumbnailBlock(true));
                }, function() {
                  if (e4.ifd1 !== void 0) {
                    var t3 = e4.ifd1.get(513), n4 = e4.ifd1.get(514);
                    return e4.chunk.getUint8Array(t3, n4);
                  }
                });
              } catch (e5) {
                return Promise.reject(e5);
            ...
            key: "createOutput",
            value: function() {
              var e4, t3, n4, r3 = {}, i4 = ye;
              Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m2(i4));
              for (var a3 = 0; a3 < i4.length; a3++)
                if (!I2(e4 = this[t3 = i4[a3]]))
                  if (n4 = this.canTranslate ? this.translateBlock(e4, t3) : k2(e4), this.options.mergeOutput) {
                    if (t3 === "ifd1")
                      continue;
                    g2(r3, n4);
                  } else
                    r3[t3] = n4;
              return this.makerNote && (r3.makerNote = this.makerNote), this.userComment && (r3.userComment = this.userComment), r3;
            }
          }, {
            key: "assignToOutput",
            value: function(e4, t3) {
              if (this.globalOptions.mergeOutput)
                ...
                Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m2(n4));
                for (var r3 = 0; r3 < n4.length; r3++) {
                  var i4 = n4[r3], a3 = i4[0], s3 = i4[1];
                  this.assignObjectToOutput(e4, a3, s3);
                }
              }
            }
          }], [{
            key: "canHandle",
            value: function(e4, t3) {
              return e4.getUint8(t3 + 1) === 225 && e4.getUint32(t3 + 4) === 1165519206 && e4.getUint16(t3 + 8) === 0;
            }
          }]), i3;
        }(function(e3) {
          a2(i3, e3);
          ...
          return r2(i3, [{
            ...
            key: "parseTags",
            value: function(e4, t3) {
              var n4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : S2(), r3 = this.options[t3], i4 = r3.pick, a3 = r3.skip, s3 = (i4 = O2(i4)).size > 0, u3 = a3.size === 0, o3 = this.chunk.getUint16(e4);
              e4 += 2;
              for (var f3 = 0; f3 < o3; f3++) {
                var c3 = this.chunk.getUint16(e4);
                if (s3) {
                  if (i4.has(c3) && (n4.set(c3, this.parseTag(e4, c3, t3)), i4.delete(c3), i4.size === 0))
                    break;
                } else
                  !u3 && a3.has(c3) || n4.set(c3, this.parseTag(e4, c3, t3));
                e4 += 12;
              }
              return n4;
            }
            ...
            key: "parseTag",
            value: function(e4, t3, n4) {
              var r3, i4 = this.chunk, a3 = i4.getUint16(e4 + 2), s3 = i4.getUint32(e4 + 4), u3 = nt[a3];
              if (u3 * s3 <= 4 ? e4 += 8 : e4 = i4.getUint32(e4 + 8), (a3 < 1 || a3 > 13) && L2("Invalid TIFF value type. block: ".concat(n4.toUpperCase(), ", tag: ").concat(t3.toString(16), ", type: ").concat(a3, ", offset ").concat(e4)), e4 > i4.byteLength && L2("Invalid TIFF value offset. block: ".concat(n4.toUpperCase(), ", tag: ").concat(t3.toString(16), ", type: ").concat(a3, ", offset ").concat(e4, " is outside of chunk size ").concat(i4.byteLength)), a3 === 1)
                return i4.getUint8Array(e4, s3);
              if (a3 === 2)
                return (r3 = function(e5) {
                  for (; e5.endsWith("\0"); )
                    e5 = e5.slice(0, -1);
                  return e5;
                }(r3 = i4.getString(e4, s3)).trim()) === "" ? void 0 : r3;
              if (a3 === 7)
                return i4.getUint8Array(e4, s3);
              if (s3 === 1)
                return this.parseTagValue(a3, e4);
              for (var o3 = new (function(e5) {
                switch (e5) {
                  case 1:
                    return Uint8Array;
                  case 3:
              ...
              }(a3))(s3), f3 = u3, c3 = 0; c3 < s3; c3++)
                o3[c3] = this.parseTagValue(a3, e4), e4 += f3;
              return o3;
            }
          }, {
            key: "parseTagValue",
            value: function(e4, t3) {
              ...
              switch (e4) {
                case 1:
                  return n4.getUint8(t3);
                case 3:
                  return n4.getUint16(t3);
                case 4:
                  return n4.getUint32(t3);
                case 5:
                  return n4.getUint32(t3) / n4.getUint32(t3 + 4);
                case 6:
                  return n4.getInt8(t3);
                case 8:
                  return n4.getInt16(t3);
                case 9:
                  return n4.getInt32(t3);
                case 10:
                  return n4.getInt32(t3) / n4.getInt32(t3 + 4);
                case 11:
                  return n4.getFloat(t3);
                case 12:
                  return n4.getDouble(t3);
                case 13:
                  return n4.getUint32(t3);
                default:
                  L2("Invalid tiff type ".concat(e4));
              }
            }
          }]), i3;
        }(De));
        function it(e3, t3, n3, r3) {
          var i3 = e3 + t3 / 60 + n3 / 3600;
          return r3 !== "S" && r3 !== "W" || (i3 *= -1), i3;
        }
        i2(rt, "type", "tiff"), i2(rt, "headerLength", 10), W.set("tiff", rt);
        ...
        var ot = ut(function(e3) {
          var t3 = new Ie(vt);
          return st(t3.read(e3), function() {
            return st(t3.parse(), function(e4) {
              if (e4 && e4.ifd0)
                return e4.ifd0[274];
            });
          });
          ...
          return st(this.thumbnail(e3), function(e4) {
            if (e4 !== void 0) {
              var t3 = new Blob([e4]);
          ...
          var t3 = new Ie(pt);
          return st(t3.read(e3), function() {
            return st(t3.extractThumbnail(), function(e4) {
              return e4 && _2 ? j2.from(e4) : e4;
            });
          });
        }), lt = {
          ifd0: false,
        ...
        if (e2.rotateCanvas = true, e2.rotateCss = true, typeof navigator == "object") {
          ...
          if (gt.includes("iPad") || gt.includes("iPhone")) {
            ...
            if (kt) {
              ...
              e2.rotateCanvas = At < 13.4, e2.rotateCss = false;
            }
          } else if (gt.includes("OS X 10")) {
            var wt = gt.match(/OS X 10[_.](\d+)/)[1];
            e2.rotateCanvas = e2.rotateCss = Number(wt) < 15;
          }
          if (gt.includes("Chrome/")) {
            var Ot = gt.match(/Chrome\/(\d+)/)[1];
            e2.rotateCanvas = e2.rotateCss = Number(Ot) < 81;
          } else if (gt.includes("Firefox/")) {
            var St = gt.match(/Firefox\/(\d+)/)[1];
            e2.rotateCanvas = e2.rotateCss = Number(St) < 77;
          }
        }
        function Pt() {
        }
        var Ut = function(e3) {
          ...
          function u3() {
            var e4;
            t2(this, u3);
            for (var r3 = arguments.length, a3 = new Array(r3), s3 = 0; s3 < r3; s3++)
              a3[s3] = arguments[s3];
            return i2(h2(e4 = n3.call.apply(n3, [this].concat(a3))), "ranges", new xt()), e4.byteLength !== 0 && e4.ranges.add(0, e4.byteLength), e4;
          }
          return r2(u3, [{
            key: "_tryExtend",
            value: function(e4, t3, n4) {
              if (e4 === 0 && this.byteLength === 0 && n4) {
                var r3 = new DataView(n4.buffer || n4, n4.byteOffset, n4.byteLength);
                this._swapDataView(r3);
              } else {
                var i3 = e4 + t3;
                if (i3 > this.byteLength) {
                  var a3 = this._extend(i3).dataView;
                  this._swapDataView(a3);
                }
              }
            }
          }, {
            ...
            value: function(e4) {
              var t3;
              t3 = _2 ? j2.allocUnsafe(e4) : new Uint8Array(e4);
              var n4 = new DataView(t3.buffer, t3.byteOffset, t3.byteLength);
              return t3.set(new Uint8Array(this.buffer, this.byteOffset, this.byteLength), 0), {
                uintView: t3,
                dataView: n4
              };
            }
            ...
            value: function(e4, t3) {
              ...
              return t3 = t3 || this._lengthToEnd(e4), n4 && this._tryExtend(e4, t3), this.ranges.add(e4, t3), v2(s2(u3.prototype), "subarray", this).call(this, e4, t3);
            }
          }, {
            key: "set",
            value: function(e4, t3) {
              var n4 = arguments.length > 2 && arguments[2] !== void 0 && arguments[2];
              n4 && this._tryExtend(t3, e4.byteLength, e4);
              var r3 = v2(s2(u3.prototype), "set", this).call(this, e4, t3);
              return this.ranges.add(t3, r3.byteLength), r3;
            }
          }, {
            key: "ensureChunk",
            value: function(e4, t3) {
              try {
                ...
                if (!n4.chunked)
                  return;
                if (n4.ranges.available(e4, t3))
                  return;
                return function(e5, t4) {
                  if (!t4)
                    return e5 && e5.then ? e5.then(Pt) : Promise.resolve();
                }(n4.readChunk(e4, t3));
              } catch (e5) {
                return Promise.reject(e5);
              }
            ...
            key: "available",
            value: function(e4, t3) {
              return this.ranges.available(e4, t3);
            }
          }]), u3;
        }(D2), xt = function() {
          function e3() {
            t2(this, e3), i2(this, "list", []);
          }
          return r2(e3, [{
            key: "length",
            get: function() {
            ...
            key: "add",
            value: function(e4, t3) {
              var n3 = e4 + t3, r3 = this.list.filter(function(t4) {
                return Ct(e4, t4.offset, n3) || Ct(e4, t4.end, n3);
              });
              if (r3.length > 0) {
                e4 = Math.min.apply(Math, [e4].concat(r3.map(function(e5) {
                  return e5.offset;
                }))), t3 = (n3 = Math.max.apply(Math, [n3].concat(r3.map(function(e5) {
                  return e5.end;
                })))) - e4;
                var i3 = r3.shift();
                i3.offset = e4, i3.length = t3, i3.end = n3, this.list = this.list.filter(function(e5) {
            ...
            value: function(e4, t3) {
              var n3 = e4 + t3;
              return this.list.some(function(t4) {
                return t4.offset <= e4 && n3 <= t4.end;
              });
            }
          }]), e3;
        }();
        ...
        function jt(e3, t3) {
          if (!t3)
            return e3 && e3.then ? e3.then(Bt) : Promise.resolve();
        }
        ...
        var Vt = function(e3) {
          ...
          return r2(i3, [{
            ...
            value: function() {
              try {
                var e4 = this;
                return e4.chunked = false, _t(Y(e4.input), function(t3) {
                  e4._swapArrayBuffer(t3);
                });
              } catch (e5) {
                return Promise.reject(e5);
              }
            ...
            key: "readChunked",
            value: function() {
              return this.chunked = true, this.size = this.input.size, v2(s2(i3.prototype), "readChunked", this).call(this);
            }
          }, {
            key: "_readChunk",
            value: function(e4, t3) {
              try {
                var n4 = this, r3 = t3 ? e4 + t3 : void 0, i4 = n4.input.slice(e4, r3);
                return _t(Y(i4), function(t4) {
                  return n4.set(t4, e4, true);
                });
              } catch (e5) {
                return Promise.reject(e5);
              }
          ...
          function s3(e4, r3) {
            var a3;
            return t2(this, s3), i2(h2(a3 = n3.call(this, 0)), "chunksRead", 0), a3.input = e4, a3.options = r3, a3;
          }
          return r2(s3, [{
            key: "readWhole",
            value: function() {
              try {
                var e4 = this;
                return e4.chunked = false, jt(e4.readChunk(e4.nextChunkOffset));
              } catch (e5) {
                return Promise.reject(e5);
              }
            }
            ...
            value: function() {
              try {
                var e4 = this;
                return e4.chunked = true, jt(e4.readChunk(0, e4.options.firstChunkSize));
              } catch (e5) {
                return Promise.reject(e5);
              }
            }
            ...
            value: function(e4) {
              try {
                var t3 = this;
                if (e4 === void 0 && (e4 = t3.nextChunkOffset), t3.fullyRead)
                  return t3.chunksRead++, false;
                var n4 = t3.options.chunkSize;
                return r3 = t3.readChunk(e4, n4), i3 = function(e5) {
                  return !!e5 && e5.byteLength === n4;
                }, a3 ? i3 ? i3(r3) : r3 : (r3 && r3.then || (r3 = Promise.resolve(r3)), i3 ? r3.then(i3) : r3);
              } catch (e5) {
                return Promise.reject(e5);
              }
              var r3, i3, a3;
            ...
            value: function(e4, t3) {
              try {
                var n4 = this;
                if (n4.chunksRead++, (t3 = n4.safeWrapAddress(e4, t3)) === 0)
                  return;
                return n4._readChunk(e4, t3);
              } catch (e5) {
                return Promise.reject(e5);
              }
            }
            ...
            key: "safeWrapAddress",
            value: function(e4, t3) {
              return this.size !== void 0 && e4 + t3 > this.size ? Math.max(0, this.size - e4) : t3;
            }
          }, {
            key: "nextChunkOffset",
            get: function() {
        ...
        K.set("blob", Vt), e2.Exifr = Ie, e2.Options = Pe, e2.allFormatters = be, e2.chunkedProps = de, e2.createDictionary = te, e2.default = at, e2.disableAllOptions = lt, e2.extendDictionary = ne, e2.fetchUrlAsArrayBuffer = G, e2.fileParsers = M2, e2.fileReaders = K, e2.gps = ft, e2.gpsOnlyOptions = dt, e2.inheritables = me, e2.orientation = ot, e2.orientationOnlyOptions = vt, e2.otherSegments = ve, e2.parse = Te, e2.readBlobAsArrayBuffer = Y, e2.rotation = function(t3) {
          return st(ot(t3), function(t4) {
            return g2({
              canvas: e2.rotateCanvas,
              css: e2.rotateCss
            }, yt[t4]);
          });
        }, e2.rotations = yt, e2.segmentParsers = W, e2.segments = pe, e2.segmentsAndBlocks = ge, e2.tagKeys = re, e2.tagRevivers = ae, e2.tagValues = ie, e2.thumbnail = ht, e2.thumbnailOnlyOptions = pt, e2.thumbnailUrl = ct, e2.tiffBlocks = ye, e2.tiffExtractables = ke, Object.defineProperty(e2, "__esModule", {
          value: true
        });
      });
    }
  ...
  var require_FileInfo = __commonJS({
    "../packages/@uppy/dashboard/lib/components/FileItem/FileInfo/index.js"(exports, module) {
      ...
      var renderAuthor = (props) => {
        ...
        }, truncateString(author.name, 13)), providerName ? h2(Fragment, null, ` ${dot} `, providerName) : null);
      };
