...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
 ...
 ${info.details}`)
  ...
  var require_mini_legacy_umd = __commonJS({
    "../node_modules/exifr/dist/mini.legacy.umd.js"(exports, module) {
      !function(e3, t3) {
        typeof exports == "object" && typeof module != "undefined" ? t3(exports) : typeof define == "function" && define.amd ? define("exifr", ["exports"], t3) : t3((e3 = typeof globalThis != "undefined" ? globalThis : e3 || self).exifr = {});
      }(exports, function(e3) {
        "use strict";
        function t3(e4, t4) {
          if (!(e4 instanceof t4))
        ...
        function r3(e4, t4, r4) {
          return t4 && n2(e4.prototype, t4), r4 && n2(e4, r4), e4;
        }
        function i3(e4, t4, n3) {
        ...
        function a3(e4, t4) {
          ...
          var n3 = ["prototype", "__proto__", "caller", "arguments", "length", "name"];
          Object.getOwnPropertyNames(t4).forEach(function(r4) {
            n3.indexOf(r4) === -1 && e4[r4] !== t4[r4] && (e4[r4] = t4[r4]);
          }), t4 && u3(e4, t4);
        }
        function s3(e4) {
        ...
        function u3(e4, t4) {
          return (u3 = Object.setPrototypeOf || function(e5, t5) {
        ...
        function f3(e4, t4, n3) {
          return (f3 = o3() ? Reflect.construct : function(e5, t5, n4) {
            var r4 = [null];
            r4.push.apply(r4, t5);
            var i4 = new (Function.bind.apply(e5, r4))();
            return n4 && u3(i4, n4.prototype), i4;
          }).apply(null, arguments);
        }
        function c3(e4) {
          var t4 = typeof Map == "function" ? /* @__PURE__ */ new Map() : void 0;
          return (c3 = function(e5) {
            if (e5 === null || (n3 = e5, Function.toString.call(n3).indexOf("[native code]") === -1))
              return e5;
            var n3;
            ...
            function r4() {
              return f3(e5, arguments, s3(this).constructor);
            }
            return r4.prototype = Object.create(e5.prototype, {
              constructor: {
                value: r4,
                enumerable: false,
                writable: true,
        ...
        function l3(e4, t4) {
          return !t4 || typeof t4 != "object" && typeof t4 != "function" ? h3(e4) : t4;
        }
        function d3(e4) {
          var t4 = o3();
          return function() {
        ...
        function v3(e4, t4, n3) {
          return (v3 = typeof Reflect != "undefined" && Reflect.get ? Reflect.get : function(e5, t5, n4) {
            var r4 = function(e6, t6) {
              for (; !Object.prototype.hasOwnProperty.call(e6, t6) && (e6 = s3(e6)) !== null; )
                ;
              return e6;
            }(e5, t5);
            if (r4) {
              var i4 = Object.getOwnPropertyDescriptor(r4, t5);
              return i4.get ? i4.get.call(n4) : i4.value;
            }
          })(e4, t4, n3 || e4);
        }
        var p3 = Object.values || function(e4) {
          var t4 = [];
          for (var n3 in e4)
            t4.push(e4[n3]);
          return t4;
        }, y3 = Object.entries || function(e4) {
          var t4 = [];
          for (var n3 in e4)
            t4.push([n3, e4[n3]]);
          return t4;
        ...
        }, k3 = Object.fromEntries || function(e4) {
          var t4 = {};
          return m3(e4).forEach(function(e5) {
            var n3 = e5[0], r4 = e5[1];
            t4[n3] = r4;
          }), t4;
        }, m3 = Array.from || function(e4) {
          if (e4 instanceof P2) {
            var t4 = [];
            return e4.forEach(function(e5, n3) {
              return t4.push([n3, e5]);
            }), t4;
          }
          return Array.prototype.slice.call(e4);
        };
        function b3(e4) {
          return this.indexOf(e4) !== -1;
        }
        Array.prototype.includes || (Array.prototype.includes = b3), String.prototype.includes || (String.prototype.includes = b3), String.prototype.startsWith || (String.prototype.startsWith = function(e4) {
          var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
          return this.substring(t4, t4 + e4.length) === e4;
        }), String.prototype.endsWith || (String.prototype.endsWith = function(e4) {
          var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.length;
          return this.substring(t4 - e4.length, t4) === e4;
        });
        var A3 = typeof self != "undefined" ? self : global, w3 = A3.fetch || function(e4) {
          var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
          return new Promise(function(n3, r4) {
            var i4 = new XMLHttpRequest();
            if (i4.open("get", e4, true), i4.responseType = "arraybuffer", i4.onerror = r4, t4.headers)
              for (var a4 in t4.headers)
                i4.setRequestHeader(a4, t4.headers[a4]);
            i4.onload = function() {
              n3({
                ok: i4.status >= 200 && i4.status < 300,
                status: i4.status,
                arrayBuffer: function() {
                  return Promise.resolve(i4.response);
                }
              });
            }, i4.send(null);
          });
          ...
          if (Object.defineProperties(t4, {
            ...
            has: {
              value: function(e5) {
                return this.indexOf(e5) !== -1;
              }
            },
            add: {
              value: function(e5) {
                this.has(e5) || this.push(e5);
              }
            },
            delete: {
              value: function(e5) {
                if (this.has(e5)) {
                  var t5 = this.indexOf(e5);
                  this.splice(t5, 1);
                }
              }
            }
          ...
          return new P2(e4);
        }, P2 = A3.Map !== void 0 && A3.Map.prototype.keys !== void 0 ? A3.Map : function() {
          function e4(n3) {
            if (t3(this, e4), this.clear(), n3)
              for (var r4 = 0; r4 < n3.length; r4++)
                this.set(n3[r4][0], n3[r4][1]);
          }
          return r3(e4, [{
            key: "clear",
            value: function() {
            ...
            key: "get",
            value: function(e5) {
              return this._map["map_" + e5];
            }
          }, {
            key: "set",
            value: function(e5, t4) {
              return this._map["map_" + e5] = t4, this._keys.indexOf(e5) < 0 && this._keys.push(e5), this;
            }
          }, {
            key: "has",
            value: function(e5) {
              return this._keys.indexOf(e5) >= 0;
            }
          }, {
            key: "delete",
            value: function(e5) {
              var t4 = this._keys.indexOf(e5);
              return !(t4 < 0) && (delete this._map["map_" + e5], this._keys.splice(t4, 1), true);
            }
          }, {
            key: "keys",
            value: function() {
            ...
            value: function() {
              var e5 = this;
              return this._keys.map(function(t4) {
                return e5.get(t4);
              });
            }
          }, {
            ...
            key: "forEach",
            value: function(e5, t4) {
              for (var n3 = 0; n3 < this._keys.length; n3++)
                e5.call(t4, this._map["map_" + this._keys[n3]], this._keys[n3], this);
            }
          }]), e4;
        }(), U = typeof self != "undefined" ? self : global, x3 = typeof navigator != "undefined", C2 = x3 && typeof HTMLImageElement == "undefined", B2 = !(typeof global == "undefined" || typeof process == "undefined" || !process.versions || !process.versions.node), j3 = U.Buffer, _3 = !!j3;
        var V = function(e4) {
          return e4 !== void 0;
        };
        function I2(e4) {
          return e4 === void 0 || (e4 instanceof P2 ? e4.size === 0 : p3(e4).filter(V).length === 0);
        }
        function L2(e4) {
          var t4 = new Error(e4);
        ...
        }, F2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf-8") : void 0;
        function E(e4) {
          return F2 ? F2.decode(e4) : _3 ? Buffer.from(e4).toString("utf8") : decodeURIComponent(escape(z3(e4)));
        }
        var D2 = function() {
          function e4(n3) {
            var r4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i4 = arguments.length > 2 ? arguments[2] : void 0, a4 = arguments.length > 3 ? arguments[3] : void 0;
            if (t3(this, e4), typeof a4 == "boolean" && (this.le = a4), Array.isArray(n3) && (n3 = new Uint8Array(n3)), n3 === 0)
              this.byteOffset = 0, this.byteLength = 0;
            else if (n3 instanceof ArrayBuffer) {
              i4 === void 0 && (i4 = n3.byteLength - r4);
              var s4 = new DataView(n3, r4, i4);
              this._swapDataView(s4);
            } else if (n3 instanceof Uint8Array || n3 instanceof DataView || n3 instanceof e4) {
              i4 === void 0 && (i4 = n3.byteLength - r4), (r4 += n3.byteOffset) + i4 > n3.byteOffset + n3.byteLength && L2("Creating view outside of available memory in ArrayBuffer");
              var u4 = new DataView(n3.buffer, r4, i4);
              this._swapDataView(u4);
            } else if (typeof n3 == "number") {
              var o4 = new DataView(new ArrayBuffer(n3));
              this._swapDataView(o4);
            } else
              L2("Invalid input argument for BufferView: " + n3);
          }
          return r3(e4, [{
            key: "_swapArrayBuffer",
            value: function(e5) {
              this._swapDataView(new DataView(e5));
            }
          }, {
            key: "_swapBuffer",
            value: function(e5) {
              this._swapDataView(new DataView(e5.buffer, e5.byteOffset, e5.byteLength));
            }
          }, {
            key: "_swapDataView",
            value: function(e5) {
              this.dataView = e5, this.buffer = e5.buffer, this.byteOffset = e5.byteOffset, this.byteLength = e5.byteLength;
            }
          }, {
            key: "_lengthToEnd",
            value: function(e5) {
              return this.byteLength - e5;
            }
          }, {
            key: "set",
            value: function(t4, n3) {
              var r4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : e4;
              t4 instanceof DataView || t4 instanceof e4 ? t4 = new Uint8Array(t4.buffer, t4.byteOffset, t4.byteLength) : t4 instanceof ArrayBuffer && (t4 = new Uint8Array(t4)), t4 instanceof Uint8Array || L2("BufferView.set(): Invalid data argument.");
              var i4 = this.toUint8();
              return i4.set(t4, n3), new r4(this, n3, t4.byteLength);
            }
          }, {
            key: "subarray",
            value: function(t4, n3) {
              return new e4(this, t4, n3 = n3 || this._lengthToEnd(t4));
            }
          }, {
            key: "toUint8",
            value: function() {
            ...
            key: "getUint8Array",
            value: function(e5, t4) {
              return new Uint8Array(this.buffer, this.byteOffset + e5, t4);
            }
          }, {
            key: "getString",
            value: function() {
              var e5 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.byteLength, n3 = this.getUint8Array(e5, t4);
              return E(n3);
            }
          }, {
            key: "getLatin1String",
            ...
            value: function() {
              for (var e5 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.byteLength, n3 = [], r4 = 0; r4 < t4 && e5 + r4 < this.byteLength; r4 += 2)
                n3.push(this.getUint16(e5 + r4));
              return z3(n3);
            }
          }, {
            key: "getInt8",
            value: function(e5) {
              return this.dataView.getInt8(e5);
            }
          }, {
            key: "getUint8",
            value: function(e5) {
              return this.dataView.getUint8(e5);
            }
          }, {
            key: "getInt16",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getInt16(e5, t4);
            }
          }, {
            key: "getInt32",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getInt32(e5, t4);
            }
          }, {
            key: "getUint16",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getUint16(e5, t4);
            }
          }, {
            key: "getUint32",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getUint32(e5, t4);
            }
          }, {
            key: "getFloat32",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getFloat32(e5, t4);
            }
          }, {
            key: "getFloat64",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.le;
              return this.dataView.getFloat64(e5, t4);
            }
          }, {
            key: "getFloat",
            value: function(e5) {
            ...
            key: "getUintBytes",
            value: function(e5, t4, n3) {
              switch (t4) {
                case 1:
                  return this.getUint8(e5, n3);
                case 2:
                  return this.getUint16(e5, n3);
                case 4:
                  return this.getUint32(e5, n3);
                case 8:
                  return this.getUint64 && this.getUint64(e5, n3);
              }
            }
          }, {
            key: "getUint",
            ...
            key: "toString",
            value: function(e5) {
              return this.dataView.toString(e5, this.constructor.name);
            }
          }, {
            key: "ensureChunk",
            value: function() {
            ...
            key: "from",
            value: function(t4, n3) {
              return t4 instanceof this && t4.le === n3 ? t4 : new e4(t4, void 0, void 0, n3);
            }
          }]), e4;
        }();
        function R(e4, t4) {
          L2("".concat(e4, " '").concat(t4, "' was not loaded, try using full build of exifr."));
        }
        var N2 = function(e4) {
          a3(i4, e4);
          var n3 = d3(i4);
          function i4(e5) {
            var r4;
            return t3(this, i4), (r4 = n3.call(this)).kind = e5, r4;
          }
          return r3(i4, [{
            key: "get",
            value: function(e5, t4) {
              return this.has(e5) || R(this.kind, e5), t4 && (e5 in t4 || function(e6, t5) {
                L2("Unknown ".concat(e6, " '").concat(t5, "'."));
              }(this.kind, e5), t4[e5].enabled || R(this.kind, e5)), v3(s3(i4.prototype), "get", this).call(this, e5);
            }
          }, {
            key: "keyList",
            value: function() {
        ...
        }(c3(P2)), M2 = new N2("file parser"), W = new N2("segment parser"), K = new N2("file reader");
        function H2(e4) {
          return function() {
            for (var t4 = [], n3 = 0; n3 < arguments.length; n3++)
              t4[n3] = arguments[n3];
            try {
              return Promise.resolve(e4.apply(this, t4));
            } catch (e5) {
        ...
        function X(e4, t4, n3) {
          return n3 ? t4 ? t4(e4) : e4 : (e4 && e4.then || (e4 = Promise.resolve(e4)), t4 ? e4.then(t4) : e4);
        }
        var Y = H2(function(e4) {
          return new Promise(function(t4, n3) {
            var r4 = new FileReader();
            r4.onloadend = function() {
              return t4(r4.result || new ArrayBuffer());
            }, r4.onerror = n3, r4.readAsArrayBuffer(e4);
          });
        }), G = H2(function(e4) {
          return w3(e4).then(function(e5) {
            return e5.arrayBuffer();
          });
        }), J = H2(function(e4, t4) {
          return X(t4(e4), function(e5) {
            return new D2(e5);
          });
        }), q3 = H2(function(e4, t4, n3) {
          var r4 = new (K.get(n3))(e4, t4);
          return X(r4.read(), function() {
            return r4;
          });
        }), Q = H2(function(e4, t4, n3, r4) {
          return K.has(n3) ? q3(e4, t4, n3) : r4 ? J(e4, r4) : (L2("Parser ".concat(n3, " is not loaded")), X());
        }), Z = "Invalid input argument";
        function $2(e4, t4) {
          return (n3 = e4).startsWith("data:") || n3.length > 1e4 ? q3(e4, t4, "base64") : x3 ? Q(e4, t4, "url", G) : B2 ? q3(e4, t4, "fs") : void L2(Z);
          var n3;
        }
        var ee = function(e4) {
          a3(i4, e4);
          var n3 = d3(i4);
          function i4() {
            return t3(this, i4), n3.apply(this, arguments);
          }
          return r3(i4, [{
            key: "tagKeys",
            get: function() {
              return this.allKeys || (this.allKeys = m3(this.keys())), this.allKeys;
            }
          }, {
            key: "tagValues",
            get: function() {
              return this.allValues || (this.allValues = m3(this.values())), this.allValues;
            }
          }]), i4;
        }(c3(P2));
        function te(e4, t4, n3) {
          var r4 = new ee(), i4 = n3;
          Array.isArray(i4) || (typeof i4.entries == "function" && (i4 = i4.entries()), i4 = m3(i4));
          for (var a4 = 0; a4 < i4.length; a4++) {
            var s4 = i4[a4], u4 = s4[0], o4 = s4[1];
            r4.set(u4, o4);
          }
          if (Array.isArray(t4)) {
            var f4 = t4;
            Array.isArray(f4) || (typeof f4.entries == "function" && (f4 = f4.entries()), f4 = m3(f4));
            for (var c4 = 0; c4 < f4.length; c4++) {
              var h4 = f4[c4];
              e4.set(h4, r4);
            }
          } else
        ...
        var re = S2(), ie = S2(), ae = S2(), se = 37500, ue = 37510, oe = 33723, fe = 34675, ce = 34665, he = 34853, le = 40965, de = ["chunked", "firstChunkSize", "firstChunkSizeNode", "firstChunkSizeBrowser", "chunkSize", "chunkLimit"], ve = ["jfif", "xmp", "icc", "iptc", "ihdr"], pe = ["tiff"].concat(ve), ye = ["ifd0", "ifd1", "exif", "gps", "interop"], ge = [].concat(pe, ye), ke = ["makerNote", "userComment"], me = ["translateKeys", "translateValues", "reviveValues", "multiSegment"], be = [].concat(me, ["sanitize", "mergeOutput", "silentErrors"]), Ae = function() {
          ...
          a3(s4, e4);
          var n3 = d3(s4);
          function s4(e5, r4, a4, u4) {
            var o4;
            if (t3(this, s4), i3(h3(o4 = n3.call(this)), "enabled", false), i3(h3(o4), "skip", O2()), i3(h3(o4), "pick", O2()), i3(h3(o4), "deps", O2()), i3(h3(o4), "translateKeys", false), i3(h3(o4), "translateValues", false), i3(h3(o4), "reviveValues", false), o4.key = e5, o4.enabled = r4, o4.parse = o4.enabled, o4.applyInheritables(u4), o4.canBeFiltered = ye.includes(e5), o4.canBeFiltered && (o4.dict = re.get(e5)), a4 !== void 0)
              if (Array.isArray(a4))
                o4.parse = o4.enabled = true, o4.canBeFiltered && a4.length > 0 && o4.translateTagSet(a4, o4.pick);
              else if (typeof a4 == "object") {
                if (o4.enabled = true, o4.parse = a4.parse !== false, o4.canBeFiltered) {
                  var f4 = a4.pick, c4 = a4.skip;
                  f4 && f4.length > 0 && o4.translateTagSet(f4, o4.pick), c4 && c4.length > 0 && o4.translateTagSet(c4, o4.skip);
                }
                o4.applyInheritables(a4);
              } else
                a4 === true || a4 === false ? o4.parse = o4.enabled = a4 : L2("Invalid options argument: ".concat(a4));
            return o4;
          }
          return r3(s4, [{
            key: "needed",
            ...
            value: function(e5) {
              var t4, n4, r4 = me;
              Array.isArray(r4) || (typeof r4.entries == "function" && (r4 = r4.entries()), r4 = m3(r4));
              for (var i4 = 0; i4 < r4.length; i4++)
                (n4 = e5[t4 = r4[i4]]) !== void 0 && (this[t4] = n4);
            }
          }, {
            key: "translateTagSet",
            value: function(e5, t4) {
              if (this.dict) {
                var n4, r4, i4 = this.dict, a4 = i4.tagKeys, s5 = i4.tagValues, u4 = e5;
                Array.isArray(u4) || (typeof u4.entries == "function" && (u4 = u4.entries()), u4 = m3(u4));
                for (var o4 = 0; o4 < u4.length; o4++)
                  typeof (n4 = u4[o4]) == "string" ? ((r4 = s5.indexOf(n4)) === -1 && (r4 = a4.indexOf(Number(n4))), r4 !== -1 && t4.add(Number(a4[r4]))) : t4.add(n4);
              } else {
                var f4 = e5;
                Array.isArray(f4) || (typeof f4.entries == "function" && (f4 = f4.entries()), f4 = m3(f4));
                for (var c4 = 0; c4 < f4.length; c4++) {
            ...
            key: "finalizeFilters",
            value: function() {
              !this.enabled && this.deps.size > 0 ? (this.enabled = true, Ce(this.pick, this.deps)) : this.enabled && this.pick.size > 0 && Ce(this.pick, this.deps);
            }
          }]), s4;
        }(Ae), Oe = {
          jfif: false,
          ...
          chunkSize: 65536,
          chunkLimit: 5
        }, Se = S2(), Pe = function(e4) {
          a3(i4, e4);
          var n3 = d3(i4);
          function i4(e5) {
            var r4;
            return t3(this, i4), r4 = n3.call(this), e5 === true ? r4.setupFromTrue() : e5 === void 0 ? r4.setupFromUndefined() : Array.isArray(e5) ? r4.setupFromArray(e5) : typeof e5 == "object" ? r4.setupFromObject(e5) : L2("Invalid options argument ".concat(e5)), r4.firstChunkSize === void 0 && (r4.firstChunkSize = x3 ? r4.firstChunkSizeBrowser : r4.firstChunkSizeNode), r4.mergeOutput && (r4.ifd1.enabled = false), r4.filterNestedSegmentTags(), r4.traverseTiffDependencyTree(), r4.checkLoadedPlugins(), r4;
          }
          return r3(i4, [{
            key: "setupFromUndefined",
            value: function() {
              var e5, t4 = de;
              Array.isArray(t4) || (typeof t4.entries == "function" && (t4 = t4.entries()), t4 = m3(t4));
              ...
              Array.isArray(u4) || (typeof u4.entries == "function" && (u4 = u4.entries()), u4 = m3(u4));
              for (var o4 = 0; o4 < u4.length; o4++)
                this[e5 = u4[o4]] = new we(e5, Oe[e5], void 0, this);
            }
          }, {
            key: "setupFromTrue",
            value: function() {
              ...
              Array.isArray(u4) || (typeof u4.entries == "function" && (u4 = u4.entries()), u4 = m3(u4));
              for (var o4 = 0; o4 < u4.length; o4++)
                this[e5 = u4[o4]] = new we(e5, true, void 0, this);
            }
          }, {
            key: "setupFromArray",
            value: function(e5) {
              var t4, n4 = de;
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m3(n4));
              for (var r4 = 0; r4 < n4.length; r4++)
                this[t4 = n4[r4]] = Oe[t4];
              var i5 = be;
              Array.isArray(i5) || (typeof i5.entries == "function" && (i5 = i5.entries()), i5 = m3(i5));
              for (var a4 = 0; a4 < i5.length; a4++)
                this[t4 = i5[a4]] = Oe[t4];
              var s4 = ke;
              Array.isArray(s4) || (typeof s4.entries == "function" && (s4 = s4.entries()), s4 = m3(s4));
              for (var u4 = 0; u4 < s4.length; u4++)
                this[t4 = s4[u4]] = Oe[t4];
              var o4 = ge;
              Array.isArray(o4) || (typeof o4.entries == "function" && (o4 = o4.entries()), o4 = m3(o4));
              for (var f4 = 0; f4 < o4.length; f4++)
                this[t4 = o4[f4]] = new we(t4, false, void 0, this);
              this.setupGlobalFilters(e5, void 0, ye);
            }
          }, {
            key: "setupFromObject",
            value: function(e5) {
              var t4;
              ye.ifd0 = ye.ifd0 || ye.image, ye.ifd1 = ye.ifd1 || ye.thumbnail, g3(this, e5);
              var n4 = de;
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m3(n4));
              for (var r4 = 0; r4 < n4.length; r4++)
                this[t4 = n4[r4]] = xe(e5[t4], Oe[t4]);
              var i5 = be;
              Array.isArray(i5) || (typeof i5.entries == "function" && (i5 = i5.entries()), i5 = m3(i5));
              for (var a4 = 0; a4 < i5.length; a4++)
                this[t4 = i5[a4]] = xe(e5[t4], Oe[t4]);
              var s4 = ke;
              Array.isArray(s4) || (typeof s4.entries == "function" && (s4 = s4.entries()), s4 = m3(s4));
              for (var u4 = 0; u4 < s4.length; u4++)
                this[t4 = s4[u4]] = xe(e5[t4], Oe[t4]);
              var o4 = pe;
              Array.isArray(o4) || (typeof o4.entries == "function" && (o4 = o4.entries()), o4 = m3(o4));
              for (var f4 = 0; f4 < o4.length; f4++)
                this[t4 = o4[f4]] = new we(t4, Oe[t4], e5[t4], this);
              var c4 = ye;
              Array.isArray(c4) || (typeof c4.entries == "function" && (c4 = c4.entries()), c4 = m3(c4));
              for (var h4 = 0; h4 < c4.length; h4++)
                this[t4 = c4[h4]] = new we(t4, Oe[t4], e5[t4], this.tiff);
              this.setupGlobalFilters(e5.pick, e5.skip, ye, ge), e5.tiff === true ? this.batchEnableWithBool(ye, true) : e5.tiff === false ? this.batchEnableWithUserValue(ye, e5) : Array.isArray(e5.tiff) ? this.setupGlobalFilters(e5.tiff, void 0, ye) : typeof e5.tiff == "object" && this.setupGlobalFilters(e5.tiff.pick, e5.tiff.skip, ye);
            }
          }, {
            ...
            value: function(e5, t4) {
              ...
              Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m3(n4));
              for (var r4 = 0; r4 < n4.length; r4++) {
                var i5 = n4[r4], a4 = t4[i5];
                this[i5].enabled = a4 !== false && a4 !== void 0;
              }
            }
          }, {
            key: "setupGlobalFilters",
            value: function(e5, t4, n4) {
              var r4 = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : n4;
              if (e5 && e5.length) {
                var i5 = r4;
                Array.isArray(i5) || (typeof i5.entries == "function" && (i5 = i5.entries()), i5 = m3(i5));
                for (var a4 = 0; a4 < i5.length; a4++) {
                ...
                var u4 = Ue(e5, n4), o4 = u4;
                Array.isArray(o4) || (typeof o4.entries == "function" && (o4 = o4.entries()), o4 = m3(o4));
                for (var f4 = 0; f4 < o4.length; f4++) {
                  var c4 = o4[f4], h4 = c4[0], l4 = c4[1];
                  Ce(this[h4].pick, l4), this[h4].enabled = true;
                }
              } else if (t4 && t4.length) {
                var d4 = Ue(t4, n4), v4 = d4;
                Array.isArray(v4) || (typeof v4.entries == "function" && (v4 = v4.entries()), v4 = m3(v4));
                for (var p4 = 0; p4 < v4.length; p4++) {
                  var y4 = v4[p4], g4 = y4[0], k4 = y4[1];
                  Ce(this[g4].skip, k4);
                }
              }
            }
            ...
            value: function() {
              var e5 = this.ifd0, t4 = this.exif, n4 = this.xmp, r4 = this.iptc, i5 = this.icc;
              this.makerNote ? t4.deps.add(se) : t4.skip.add(se), this.userComment ? t4.deps.add(ue) : t4.skip.add(ue), n4.enabled || e5.skip.add(700), r4.enabled || e5.skip.add(oe), i5.enabled || e5.skip.add(fe);
            }
          }, {
            key: "traverseTiffDependencyTree",
            value: function() {
              var e5 = this, t4 = this.ifd0, n4 = this.exif, r4 = this.gps;
              this.interop.needed && (n4.deps.add(le), t4.deps.add(le)), n4.needed && t4.deps.add(ce), r4.needed && t4.deps.add(he), this.tiff.enabled = ye.some(function(t5) {
                return e5[t5].enabled === true;
              }) || this.makerNote || this.userComment;
              var i5 = ye;
              Array.isArray(i5) || (typeof i5.entries == "function" && (i5 = i5.entries()), i5 = m3(i5));
              for (var a4 = 0; a4 < i5.length; a4++) {
                this[i5[a4]].finalizeFilters();
              }
            }
          }, {
            key: "onlyTiff",
            get: function() {
              var e5 = this;
              return !ve.map(function(t4) {
                return e5[t4].enabled;
              }).some(function(e6) {
                return e6 === true;
              }) && this.tiff.enabled;
            }
            ...
            value: function() {
              var e5 = pe;
              Array.isArray(e5) || (typeof e5.entries == "function" && (e5 = e5.entries()), e5 = m3(e5));
              for (var t4 = 0; t4 < e5.length; t4++) {
                var n4 = e5[t4];
                this[n4].enabled && !W.has(n4) && R("segment parser", n4);
              }
            }
          }], [{
            key: "useCached",
            value: function(e5) {
              var t4 = Se.get(e5);
              return t4 !== void 0 || (t4 = new this(e5), Se.set(e5, t4)), t4;
            }
          }]), i4;
        }(Ae);
        function Ue(e4, t4) {
          var n3, r4, i4, a4 = [], s4 = t4;
          Array.isArray(s4) || (typeof s4.entries == "function" && (s4 = s4.entries()), s4 = m3(s4));
          for (var u4 = 0; u4 < s4.length; u4++) {
            r4 = s4[u4], n3 = [];
            var o4 = re.get(r4);
            Array.isArray(o4) || (typeof o4.entries == "function" && (o4 = o4.entries()), o4 = m3(o4));
            for (var f4 = 0; f4 < o4.length; f4++)
              i4 = o4[f4], (e4.includes(i4[0]) || e4.includes(i4[1])) && n3.push(i4[0]);
            n3.length && a4.push([r4, n3]);
          }
          return a4;
        }
        function xe(e4, t4) {
        ...
        function Ce(e4, t4) {
          var n3 = t4;
          Array.isArray(n3) || (typeof n3.entries == "function" && (n3 = n3.entries()), n3 = m3(n3));
          for (var r4 = 0; r4 < n3.length; r4++) {
            var i4 = n3[r4];
            e4.add(i4);
          }
        ...
        function _e(e4, t4) {
          if (!t4)
            return e4 && e4.then ? e4.then(je) : Promise.resolve();
        }
        function Ve(e4, t4) {
          var n3 = e4();
          return n3 && n3.then ? n3.then(t4) : t4(n3);
        }
        i3(Pe, "default", Oe);
        var Ie = function() {
          function e4(n3) {
            t3(this, e4), i3(this, "parsers", {}), this.options = Pe.useCached(n3);
          }
          return r3(e4, [{
            key: "setup",
            value: function() {
              if (!this.fileParser) {
                var e5 = this.file, t4 = e5.getUint16(0), n3 = M2;
                Array.isArray(n3) || (typeof n3.entries == "function" && (n3 = n3.entries()), n3 = m3(n3));
                for (var r4 = 0; r4 < n3.length; r4++) {
                  var i4 = n3[r4], a4 = i4[0], s4 = i4[1];
                  if (s4.canHandle(e5, t4))
                    return this.fileParser = new s4(this.options, this.file, this.parsers), e5[a4] = true;
                }
                L2("Unknown file format");
              }
            }
          }, {
            key: "read",
            value: function(e5) {
              try {
                var t4 = this;
                return Be(function(e6, t5) {
                  return typeof e6 == "string" ? $2(e6, t5) : x3 && !C2 && e6 instanceof HTMLImageElement ? $2(e6.src, t5) : e6 instanceof Uint8Array || e6 instanceof ArrayBuffer || e6 instanceof DataView ? new D2(e6) : x3 && e6 instanceof Blob ? Q(e6, t5, "blob", Y) : void L2(Z);
                }(e5, t4.options), function(e6) {
                  t4.file = e6;
                });
              } catch (e6) {
            ...
            value: function() {
              try {
                ...
                var t4 = {}, n3 = [];
                return Ve(function() {
                  return e5.options.silentErrors ? Be(e5.doParse(t4, n3).catch(function(e6) {
                    return n3.push(e6);
                  }), function() {
                    n3.push.apply(n3, e5.fileParser.errors);
                  }) : _e(e5.doParse(t4, n3));
                }, function() {
                  return e5.file.close && e5.file.close(), e5.options.silentErrors && n3.length > 0 && (t4.errors = n3), I2(r4 = t4) ? void 0 : r4;
                  var r4;
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            value: function(e5, t4) {
              try {
                var n3 = this;
                return Be(n3.fileParser.parse(), function() {
                  var r4, i4 = p3(n3.parsers).map((r4 = function(t5) {
                    return Be(t5.parse(), function(n4) {
                      t5.assignToOutput(e5, n4);
                    });
                  }, function() {
                    for (var e6 = [], t5 = 0; t5 < arguments.length; t5++)
                      e6[t5] = arguments[t5];
                    try {
                      return Promise.resolve(r4.apply(this, e6));
                    } catch (e7) {
                      return Promise.reject(e7);
                    }
                  }));
                  if (n3.options.silentErrors) {
                    var a4 = function(e6) {
                      return t4.push(e6);
                    };
                    i4 = i4.map(function(e6) {
                      return e6.catch(a4);
                    });
                  }
                  return _e(Promise.all(i4));
                });
              } catch (e6) {
                return Promise.reject(e6);
              }
            ...
            value: function() {
              try {
                var e5 = this;
                e5.setup();
                var t4, n3 = e5.options, r4 = e5.file, i4 = W.get("tiff", n3);
                return Ve(function() {
                  if (!r4.tiff)
                    return function(e6) {
                      var t5 = e6();
                      ...
                      if (r4.jpeg)
                        return Be(e5.fileParser.getOrFindSegment("tiff"), function(e6) {
                          t4 = e6;
                        });
                    });
                  t4 = {
                  ...
                  if (t4 !== void 0)
                    return Be(e5.fileParser.ensureSegmentChunk(t4), function(t5) {
                      return Be((e5.parsers.tiff = new i4(t5, n3, r4)).extractThumbnail(), function(e6) {
                        return r4.close && r4.close(), e6;
                      });
                    });
                });
              } catch (e6) {
        ...
        var Le, Te = (Le = function(e4, t4) {
          var n3, r4, i4, a4 = new Ie(t4);
          return n3 = a4.read(e4), r4 = function() {
            return a4.parse();
          }, i4 ? r4 ? r4(n3) : n3 : (n3 && n3.then || (n3 = Promise.resolve(n3)), r4 ? n3.then(r4) : n3);
        }, function() {
          for (var e4 = [], t4 = 0; t4 < arguments.length; t4++)
            e4[t4] = arguments[t4];
          try {
            return Promise.resolve(Le.apply(this, e4));
          } catch (e5) {
            return Promise.reject(e5);
          }
        }), ze = Object.freeze({
        ...
        var Ee = function() {
          function e4(n3, r4, a4) {
            var s4 = this;
            t3(this, e4), i3(this, "errors", []), i3(this, "ensureSegmentChunk", function(e5) {
              return function() {
                for (var t4 = [], n4 = 0; n4 < arguments.length; n4++)
                  t4[n4] = arguments[n4];
                try {
                  return Promise.resolve(e5.apply(this, t4));
                } catch (e6) {
                  return Promise.reject(e6);
                }
              };
            }(function(e5) {
              var t4, n4, r5, i4 = e5.start, a5 = e5.size || 65536;
              return t4 = function() {
                if (s4.file.chunked)
                  return function(e6) {
                    var t5 = e6();
                    ...
                    if (!s4.file.available(i4, a5))
                      return function(e6) {
                        ...
                        return n5 && n5.then ? n5.then(void 0, t5) : n5;
                      }(function() {
                        return t5 = s4.file.readChunk(i4, a5), n5 = function(t6) {
                          e5.chunk = t6;
                        }, r6 ? n5 ? n5(t5) : t5 : (t5 && t5.then || (t5 = Promise.resolve(t5)), n5 ? t5.then(n5) : t5);
                        var t5, n5, r6;
                      }, function(t5) {
                        L2("Couldn't read segment: ".concat(JSON.stringify(e5), ". ").concat(t5.message));
                      }));
                    e5.chunk = s4.file.subarray(i4, a5);
                  });
                s4.file.byteLength > i4 + a5 ? e5.chunk = s4.file.subarray(i4, a5) : e5.size === void 0 ? e5.chunk = s4.file.subarray(i4) : L2("Segment unreachable: " + JSON.stringify(e5));
              }, n4 = function() {
                return e5.chunk;
              }, (r5 = t4()) && r5.then ? r5.then(n4) : n4(r5);
            })), this.extendOptions && this.extendOptions(n3), this.options = n3, this.file = r4, this.parsers = a4;
          }
          return r3(e4, [{
            key: "injectSegment",
            value: function(e5, t4) {
              this.options[e5].enabled && this.createParser(e5, t4);
            }
          }, {
            key: "createParser",
            value: function(e5, t4) {
              var n3 = new (W.get(e5))(t4, this.options, this.file);
              return this.parsers[e5] = n3;
            }
          }, {
            key: "createParsers",
            value: function(e5) {
              ...
              Array.isArray(t4) || (typeof t4.entries == "function" && (t4 = t4.entries()), t4 = m3(t4));
              for (var n3 = 0; n3 < t4.length; n3++) {
                var r4 = t4[n3], i4 = r4.type, a4 = r4.chunk, s4 = this.options[i4];
                if (s4 && s4.enabled) {
                  var u4 = this.parsers[i4];
                  u4 && u4.append || u4 || this.createParser(i4, a4);
                }
              }
            }
          }, {
            ...
            value: function(e5) {
              try {
                var t4 = e5.map(this.ensureSegmentChunk);
                return function(e6, t5) {
                  if (!t5)
                    return e6 && e6.then ? e6.then(Fe) : Promise.resolve();
                }(Promise.all(t4));
              } catch (e6) {
                return Promise.reject(e6);
              }
          ...
          function e4(n3) {
            var r4 = this, a4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, s4 = arguments.length > 2 ? arguments[2] : void 0;
            t3(this, e4), i3(this, "errors", []), i3(this, "raw", S2()), i3(this, "handleError", function(e5) {
              if (!r4.options.silentErrors)
                throw e5;
              r4.errors.push(e5.message);
            }), this.chunk = this.normalizeInput(n3), this.file = s4, this.type = this.constructor.type, this.globalOptions = this.options = a4, this.localOptions = a4[this.type], this.canTranslate = this.localOptions && this.localOptions.translate;
          }
          return r3(e4, [{
            key: "normalizeInput",
            value: function(e5) {
              return e5 instanceof D2 ? e5 : new D2(e5);
            }
          }, {
            key: "translate",
            value: function() {
            ...
            key: "output",
            get: function() {
              return this.translated ? this.translated : this.raw ? k3(this.raw) : void 0;
            }
          }, {
            key: "translateBlock",
            value: function(e5, t4) {
              var n3 = ae.get(t4), r4 = ie.get(t4), i4 = re.get(t4), a4 = this.options[t4], s4 = a4.reviveValues && !!n3, u4 = a4.translateValues && !!r4, o4 = a4.translateKeys && !!i4, f4 = {}, c4 = e5;
              Array.isArray(c4) || (typeof c4.entries == "function" && (c4 = c4.entries()), c4 = m3(c4));
              for (var h4 = 0; h4 < c4.length; h4++) {
                var l4 = c4[h4], d4 = l4[0], v4 = l4[1];
                s4 && n3.has(d4) ? v4 = n3.get(d4)(v4) : u4 && r4.has(d4) && (v4 = this.translateValue(v4, r4.get(d4))), o4 && i4.has(d4) && (d4 = i4.get(d4) || d4), f4[d4] = v4;
              }
              return f4;
            }
          }, {
            key: "translateValue",
            value: function(e5, t4) {
              return t4[e5] || t4.DEFAULT || e5;
            }
          }, {
            key: "assignToOutput",
            value: function(e5, t4) {
              this.assignObjectToOutput(e5, this.constructor.type, t4);
            }
          }, {
            ...
            value: function(e5, t4, n3) {
              if (this.globalOptions.mergeOutput)
                return g3(e5, n3);
              e5[t4] ? g3(e5[t4], n3) : e5[t4] = n3;
            }
          }], [{
            key: "findPosition",
            value: function(e5, t4) {
              var n3 = e5.getUint16(t4 + 2) + 2, r4 = typeof this.headerLength == "function" ? this.headerLength(e5, t4, n3) : this.headerLength, i4 = t4 + r4, a4 = n3 - r4;
              return {
                offset: t4,
                length: n3,
                headerLength: r4,
            ...
            key: "parse",
            value: function(e5) {
              var t4 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n3 = new Pe(i3({}, this.type, t4)), r4 = new this(e5, n3);
              return r4.parse();
            }
          }]), e4;
        }();
        ...
        i3(De, "headerLength", 4), i3(De, "type", void 0), i3(De, "multiSegment", false), i3(De, "canHandle", function() {
          return false;
        });
        function Ne() {
        }
        function Me(e4, t4) {
          if (!t4)
            return e4 && e4.then ? e4.then(Ne) : Promise.resolve();
        }
        function We(e4) {
          var t4 = e4();
          if (t4 && t4.then)
        ...
        function He(e4, t4, n3) {
          if (!e4.s) {
            if (n3 instanceof Xe) {
              if (!n3.s)
                return void (n3.o = He.bind(null, e4, t4));
              1 & t4 && (t4 = n3.s), n3 = n3.v;
            }
            if (n3 && n3.then)
              return void n3.then(He.bind(null, e4, t4), He.bind(null, e4, 2));
            e4.s = t4, e4.v = n3;
            var r4 = e4.o;
            r4 && r4(e4);
          }
        ...
        var Xe = function() {
          ...
          return e4.prototype.then = function(t4, n3) {
            var r4 = new e4(), i4 = this.s;
            if (i4) {
              var a4 = 1 & i4 ? t4 : n3;
              if (a4) {
                try {
            ...
            return this.o = function(e5) {
              try {
                var i5 = e5.v;
                1 & e5.s ? He(r4, 1, t4 ? t4(i5) : i5) : n3 ? He(r4, 1, n3(i5)) : He(r4, 2, i5);
              } catch (e6) {
                He(r4, 2, e6);
              }
            }, r4;
        ...
        function Ye(e4) {
          return e4 instanceof Xe && 1 & e4.s;
        }
        function Ge(e4, t4, n3) {
          ...
          var u4 = new Xe(), o4 = He.bind(null, u4, 2);
          return (r4 === 0 ? i4.then(c4) : r4 === 1 ? a4.then(f4) : s4.then(h4)).then(void 0, o4), u4;
          function f4(r5) {
            a4 = r5;
            do {
              if (t4 && (s4 = t4()) && s4.then && !Ye(s4))
                return void s4.then(h4).then(void 0, o4);
              if (!(i4 = e4()) || Ye(i4) && !i4.v)
                return void He(u4, 1, a4);
              if (i4.then)
                return void i4.then(c4).then(void 0, o4);
              Ye(a4 = n3()) && (a4 = a4.v);
            } while (!a4 || !a4.then);
            a4.then(f4).then(void 0, o4);
          }
          function c4(e5) {
            e5 ? (a4 = n3()) && a4.then ? a4.then(f4).then(void 0, o4) : f4(a4) : He(u4, 1, a4);
          }
          function h4() {
            (i4 = e4()) ? i4.then ? i4.then(c4).then(void 0, o4) : c4(i4) : He(u4, 1, a4);
          }
        }
        function Je(e4) {
        ...
        function Qe(e4, t4, n3) {
          ...
          Array.isArray(r4) || (typeof r4.entries == "function" && (r4 = r4.entries()), r4 = m3(r4));
          for (var i4 = 0; i4 < r4.length; i4++) {
            var a4 = r4[i4], s4 = a4[0];
            if (a4[1].canHandle(e4, t4, n3))
              return s4;
          }
        }
        var Ze = function(e4) {
          ...
          function s4() {
            var e5;
            t3(this, s4);
            for (var r4 = arguments.length, a4 = new Array(r4), u4 = 0; u4 < r4; u4++)
              a4[u4] = arguments[u4];
            return i3(h3(e5 = n3.call.apply(n3, [this].concat(a4))), "appSegments", []), i3(h3(e5), "jpegSegments", []), i3(h3(e5), "unknownSegments", []), e5;
          }
          return r3(s4, [{
            key: "parse",
            value: function() {
              try {
                var e5 = this;
                return Re(e5.findAppSegments(), function() {
                  return Re(e5.readSegments(e5.appSegments), function() {
                    e5.mergeMultiSegments(), e5.createParsers(e5.mergedAppSegments || e5.appSegments);
                  });
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            value: function(e5) {
              var t4 = this;
              e5 === true ? (this.findAll = true, this.wanted = O2(W.keyList())) : (e5 = e5 === void 0 ? W.keyList().filter(function(e6) {
                return t4.options[e6].enabled;
              }) : e5.filter(function(e6) {
                return t4.options[e6].enabled && W.has(e6);
              }), this.findAll = false, this.remaining = O2(e5), this.wanted = O2(e5)), this.unfinishedMultiSegment = false;
            }
          }, {
            key: "findAppSegments",
            value: function() {
              var e5 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t4 = arguments.length > 1 ? arguments[1] : void 0;
              try {
                var n4 = this;
                n4.setupSegmentFinderArgs(t4);
                var r4 = n4.file, i4 = n4.findAll, a4 = n4.wanted, s5 = n4.remaining;
                return Ke(function() {
                  if (!i4 && n4.file.chunked)
                    return i4 = m3(a4).some(function(e6) {
                      var t5 = W.get(e6), r5 = n4.options[e6];
                      return t5.multiSegment && r5.multiSegment;
                    }), We(function() {
                      if (i4)
                        return Me(n4.file.readWhole());
                    });
                }, function() {
                  var t5 = false;
                  if (e5 = n4.findAppSegmentsInRange(e5, r4.byteLength), !n4.options.onlyTiff)
                    return function() {
                      if (r4.chunked) {
                        var i5 = false;
                        return Ge(function() {
                          return !t5 && s5.size > 0 && !i5 && (!!r4.canReadNextChunk || !!n4.unfinishedMultiSegment);
                        }, void 0, function() {
                          var a5 = r4.nextChunkOffset, s6 = n4.appSegments.some(function(e6) {
                            return !n4.file.available(e6.offset || e6.start, e6.length || e6.size);
                          });
                          return Ke(function() {
                            return e5 > a5 && !s6 ? Re(r4.readNextChunk(e5), function(e6) {
                              i5 = !e6;
                            }) : Re(r4.readNextChunk(a5), function(e6) {
                              i5 = !e6;
                            });
                          }, function() {
                            (e5 = n4.findAppSegmentsInRange(e5, r4.byteLength)) === void 0 && (t5 = true);
                          });
                        });
                      }
                    }();
            ...
            value: function(e5, t4) {
              t4 -= 2;
              for (var n4, r4, i4, a4, s5, u4, o4 = this.file, f4 = this.findAll, c4 = this.wanted, h4 = this.remaining, l4 = this.options; e5 < t4; e5++)
                if (o4.getUint8(e5) === 255) {
                  if (qe(n4 = o4.getUint8(e5 + 1))) {
                    if (r4 = o4.getUint16(e5 + 2), (i4 = Qe(o4, e5, r4)) && c4.has(i4) && (s5 = (a4 = W.get(i4)).findPosition(o4, e5), u4 = l4[i4], s5.type = i4, this.appSegments.push(s5), !f4 && (a4.multiSegment && u4.multiSegment ? (this.unfinishedMultiSegment = s5.chunkNumber < s5.chunkCount, this.unfinishedMultiSegment || h4.delete(i4)) : h4.delete(i4), h4.size === 0)))
                      break;
                    l4.recordUnknownSegments && ((s5 = De.findPosition(o4, e5)).marker = n4, this.unknownSegments.push(s5)), e5 += r4 + 1;
                  } else if (Je(n4)) {
                    if (r4 = o4.getUint16(e5 + 2), n4 === 218 && l4.stopAfterSos !== false)
                      return;
                    l4.recordJpegSegments && this.jpegSegments.push({
                      offset: e5,
                      length: r4,
                      marker: n4
                    }), e5 += r4 + 1;
            ...
            value: function() {
              var e5 = this;
              if (this.appSegments.some(function(e6) {
                return e6.multiSegment;
              })) {
                var t4 = function(e6, t5) {
                  for (var n4, r4, i4, a4 = S2(), s5 = 0; s5 < e6.length; s5++)
                    r4 = (n4 = e6[s5])[t5], a4.has(r4) ? i4 = a4.get(r4) : a4.set(r4, i4 = []), i4.push(n4);
                  return m3(a4);
                }(this.appSegments, "type");
                this.mergedAppSegments = t4.map(function(t5) {
                  var n4 = t5[0], r4 = t5[1], i4 = W.get(n4, e5.options);
                  return i4.handleMultiSegments ? {
                    type: n4,
                    chunk: i4.handleMultiSegments(r4)
                  } : r4[0];
                });
              }
            }
            ...
            key: "getSegment",
            value: function(e5) {
              return this.appSegments.find(function(t4) {
                return t4.type === e5;
              });
            }
          }, {
            ...
            value: function(e5) {
              try {
                var t4 = this, n4 = t4.getSegment(e5);
                return Ke(function() {
                  if (n4 === void 0)
                    return Re(t4.findAppSegments(0, [e5]), function() {
                      n4 = t4.getSegment(e5);
                    });
                }, function() {
                  return n4;
        ...
        i3(Ze, "type", "jpeg"), M2.set("jpeg", Ze);
        function et(e4, t4) {
          if (!t4)
            return e4 && e4.then ? e4.then($e) : Promise.resolve();
        }
        function tt(e4, t4) {
          var n3 = e4();
          return n3 && n3.then ? n3.then(t4) : t4(n3);
        ...
        var rt = function(e4) {
          ...
          return r3(i4, [{
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  if (t4.ifd0.enabled)
                    return et(e5.parseIfd0Block());
                }, function() {
                  return tt(function() {
                    if (t4.exif.enabled)
                      return et(e5.safeParse("parseExifBlock"));
                  }, function() {
                    return tt(function() {
                      if (t4.gps.enabled)
                        return et(e5.safeParse("parseGpsBlock"));
                    }, function() {
                      return tt(function() {
                        if (t4.interop.enabled)
                          return et(e5.safeParse("parseInteropBlock"));
                      }, function() {
                        return tt(function() {
                          if (t4.ifd1.enabled)
                            return et(e5.safeParse("parseThumbnailBlock"));
                        }, function() {
                          return e5.createOutput();
                        });
                      });
                    });
                  });
            ...
            value: function() {
              if (this.ifd1Offset === void 0) {
                this.findIfd0Offset();
                var e5 = this.chunk.getUint16(this.ifd0Offset), t4 = this.ifd0Offset + 2 + 12 * e5;
            ...
            value: function(e5, t4) {
              var n4 = S2();
              return this[t4] = n4, this.parseTags(e5, t4, n4), n4;
            }
          }, {
            key: "parseIfd0Block",
            value: function() {
              try {
                ...
                if (e5.ifd0)
                  return;
                var t4 = e5.file;
                return e5.findIfd0Offset(), e5.ifd0Offset < 8 && L2("Malformed EXIF data"), !t4.chunked && e5.ifd0Offset > t4.byteLength && L2("IFD0 offset points to outside of file.\nthis.ifd0Offset: ".concat(e5.ifd0Offset, ", file.byteLength: ").concat(t4.byteLength)), tt(function() {
                  if (t4.tiff)
                    return et(t4.ensureChunk(e5.ifd0Offset, T3(e5.options)));
                }, function() {
                  var t5 = e5.parseBlock(e5.ifd0Offset, "ifd0");
                  if (t5.size !== 0)
                    return e5.exifOffset = t5.get(ce), e5.interopOffset = t5.get(le), e5.gpsOffset = t5.get(he), e5.xmp = t5.get(700), e5.iptc = t5.get(oe), e5.icc = t5.get(fe), e5.options.sanitize && (t5.delete(ce), t5.delete(le), t5.delete(he), t5.delete(700), t5.delete(oe), t5.delete(fe)), t5;
                });
              } catch (e6) {
                return Promise.reject(e6);
              }
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  if (e5.exifOffset !== void 0)
                    return tt(function() {
                      if (e5.file.tiff)
                        return et(e5.file.ensureChunk(e5.exifOffset, T3(e5.options)));
                    }, function() {
                      var t4 = e5.parseBlock(e5.exifOffset, "exif");
                      return e5.interopOffset || (e5.interopOffset = t4.get(le)), e5.makerNote = t4.get(se), e5.userComment = t4.get(ue), e5.options.sanitize && (t4.delete(le), t4.delete(se), t4.delete(ue)), e5.unpack(t4, 41728), e5.unpack(t4, 41729), t4;
                    });
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  if (e5.gpsOffset !== void 0) {
                    var t4 = e5.parseBlock(e5.gpsOffset, "gps");
                    return t4 && t4.has(2) && t4.has(4) && (t4.set("latitude", it.apply(void 0, t4.get(2).concat([t4.get(1)]))), t4.set("longitude", it.apply(void 0, t4.get(4).concat([t4.get(3)])))), t4;
                  }
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            value: function() {
              try {
                ...
                return tt(function() {
                  ...
                  return tt(function() {
                    if (e5.interopOffset === void 0 && !e5.exif)
                      return et(e5.parseExifBlock());
                  }, function() {
                    if (e5.interopOffset !== void 0)
                      return e5.parseBlock(e5.interopOffset, "interop");
                  });
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            value: function() {
              ...
              try {
                var t4 = this;
                if (t4.ifd1 || t4.ifd1Parsed)
                  return;
                if (t4.options.mergeOutput && !e5)
                  return;
                return t4.findIfd1Offset(), t4.ifd1Offset > 0 && (t4.parseBlock(t4.ifd1Offset, "ifd1"), t4.ifd1Parsed = true), t4.ifd1;
              } catch (e6) {
                return Promise.reject(e6);
              }
            }
            ...
            value: function() {
              try {
                var e5 = this;
                return e5.headerParsed || e5.parseHeader(), tt(function() {
                  if (!e5.ifd1Parsed)
                    return et(e5.parseThumbnailBlock(true));
                }, function() {
                  if (e5.ifd1 !== void 0) {
                    var t4 = e5.ifd1.get(513), n4 = e5.ifd1.get(514);
                    return e5.chunk.getUint8Array(t4, n4);
                  }
                });
              } catch (e6) {
                return Promise.reject(e6);
            ...
            key: "createOutput",
            value: function() {
              var e5, t4, n4, r4 = {}, i5 = ye;
              Array.isArray(i5) || (typeof i5.entries == "function" && (i5 = i5.entries()), i5 = m3(i5));
              for (var a4 = 0; a4 < i5.length; a4++)
                if (!I2(e5 = this[t4 = i5[a4]]))
                  if (n4 = this.canTranslate ? this.translateBlock(e5, t4) : k3(e5), this.options.mergeOutput) {
                    if (t4 === "ifd1")
                      continue;
                    g3(r4, n4);
                  } else
                    r4[t4] = n4;
              return this.makerNote && (r4.makerNote = this.makerNote), this.userComment && (r4.userComment = this.userComment), r4;
            }
          }, {
            key: "assignToOutput",
            value: function(e5, t4) {
              if (this.globalOptions.mergeOutput)
                ...
                Array.isArray(n4) || (typeof n4.entries == "function" && (n4 = n4.entries()), n4 = m3(n4));
                for (var r4 = 0; r4 < n4.length; r4++) {
                  var i5 = n4[r4], a4 = i5[0], s4 = i5[1];
                  this.assignObjectToOutput(e5, a4, s4);
                }
              }
            }
          }], [{
            key: "canHandle",
            value: function(e5, t4) {
              return e5.getUint8(t4 + 1) === 225 && e5.getUint32(t4 + 4) === 1165519206 && e5.getUint16(t4 + 8) === 0;
            }
          }]), i4;
        }(function(e4) {
          a3(i4, e4);
          ...
          return r3(i4, [{
            key: "parseHeader",
            value: function() {
              var e5 = this.chunk.getUint16();
              e5 === 18761 ? this.le = true : e5 === 19789 && (this.le = false), this.chunk.le = this.le, this.headerParsed = true;
            }
          }, {
            key: "parseTags",
            value: function(e5, t4) {
              var n4 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : S2(), r4 = this.options[t4], i5 = r4.pick, a4 = r4.skip, s4 = (i5 = O2(i5)).size > 0, u4 = a4.size === 0, o4 = this.chunk.getUint16(e5);
              e5 += 2;
              for (var f4 = 0; f4 < o4; f4++) {
                var c4 = this.chunk.getUint16(e5);
                if (s4) {
                  if (i5.has(c4) && (n4.set(c4, this.parseTag(e5, c4, t4)), i5.delete(c4), i5.size === 0))
                    break;
                } else
                  !u4 && a4.has(c4) || n4.set(c4, this.parseTag(e5, c4, t4));
                e5 += 12;
              }
              return n4;
            }
            ...
            key: "parseTag",
            value: function(e5, t4, n4) {
              var r4, i5 = this.chunk, a4 = i5.getUint16(e5 + 2), s4 = i5.getUint32(e5 + 4), u4 = nt[a4];
              if (u4 * s4 <= 4 ? e5 += 8 : e5 = i5.getUint32(e5 + 8), (a4 < 1 || a4 > 13) && L2("Invalid TIFF value type. block: ".concat(n4.toUpperCase(), ", tag: ").concat(t4.toString(16), ", type: ").concat(a4, ", offset ").concat(e5)), e5 > i5.byteLength && L2("Invalid TIFF value offset. block: ".concat(n4.toUpperCase(), ", tag: ").concat(t4.toString(16), ", type: ").concat(a4, ", offset ").concat(e5, " is outside of chunk size ").concat(i5.byteLength)), a4 === 1)
                return i5.getUint8Array(e5, s4);
              if (a4 === 2)
                return (r4 = function(e6) {
                  for (; e6.endsWith("\0"); )
                    e6 = e6.slice(0, -1);
                  return e6;
                }(r4 = i5.getString(e5, s4)).trim()) === "" ? void 0 : r4;
              if (a4 === 7)
                return i5.getUint8Array(e5, s4);
              if (s4 === 1)
                return this.parseTagValue(a4, e5);
              for (var o4 = new (function(e6) {
                switch (e6) {
                  case 1:
                    return Uint8Array;
                  case 3:
              ...
              }(a4))(s4), f4 = u4, c4 = 0; c4 < s4; c4++)
                o4[c4] = this.parseTagValue(a4, e5), e5 += f4;
              return o4;
            }
          }, {
            key: "parseTagValue",
            value: function(e5, t4) {
              ...
              switch (e5) {
                case 1:
                  return n4.getUint8(t4);
                case 3:
                  return n4.getUint16(t4);
                case 4:
                  return n4.getUint32(t4);
                case 5:
                  return n4.getUint32(t4) / n4.getUint32(t4 + 4);
                case 6:
                  return n4.getInt8(t4);
                case 8:
                  return n4.getInt16(t4);
                case 9:
                  return n4.getInt32(t4);
                case 10:
                  return n4.getInt32(t4) / n4.getInt32(t4 + 4);
                case 11:
                  return n4.getFloat(t4);
                case 12:
                  return n4.getDouble(t4);
                case 13:
                  return n4.getUint32(t4);
                default:
                  L2("Invalid tiff type ".concat(e5));
              }
            }
          }]), i4;
        }(De));
        function it(e4, t4, n3, r4) {
          var i4 = e4 + t4 / 60 + n3 / 3600;
          return r4 !== "S" && r4 !== "W" || (i4 *= -1), i4;
        }
        i3(rt, "type", "tiff"), i3(rt, "headerLength", 10), W.set("tiff", rt);
        ...
        var ot = ut(function(e4) {
          var t4 = new Ie(vt);
          return st(t4.read(e4), function() {
            return st(t4.parse(), function(e5) {
              if (e5 && e5.ifd0)
                return e5.ifd0[274];
            });
          });
          ...
          return st(this.thumbnail(e4), function(e5) {
            if (e5 !== void 0) {
              var t4 = new Blob([e5]);
          ...
          var t4 = new Ie(pt);
          return st(t4.read(e4), function() {
            return st(t4.extractThumbnail(), function(e5) {
              return e5 && _3 ? j3.from(e5) : e5;
            });
          });
        }), lt = {
          ifd0: false,
        ...
        if (e3.rotateCanvas = true, e3.rotateCss = true, typeof navigator == "object") {
          var gt = navigator.userAgent;
          if (gt.includes("iPad") || gt.includes("iPhone")) {
            var kt = gt.match(/OS (\d+)_(\d+)/);
            if (kt) {
              var mt = kt[1], bt = kt[2], At = Number(mt) + 0.1 * Number(bt);
              e3.rotateCanvas = At < 13.4, e3.rotateCss = false;
            }
          } else if (gt.includes("OS X 10")) {
            var wt = gt.match(/OS X 10[_.](\d+)/)[1];
            e3.rotateCanvas = e3.rotateCss = Number(wt) < 15;
          }
          if (gt.includes("Chrome/")) {
            var Ot = gt.match(/Chrome\/(\d+)/)[1];
            e3.rotateCanvas = e3.rotateCss = Number(Ot) < 81;
          } else if (gt.includes("Firefox/")) {
            var St = gt.match(/Firefox\/(\d+)/)[1];
            e3.rotateCanvas = e3.rotateCss = Number(St) < 77;
          }
        }
        function Pt() {
        }
        var Ut = function(e4) {
          ...
          function u4() {
            var e5;
            t3(this, u4);
            for (var r4 = arguments.length, a4 = new Array(r4), s4 = 0; s4 < r4; s4++)
              a4[s4] = arguments[s4];
            return i3(h3(e5 = n3.call.apply(n3, [this].concat(a4))), "ranges", new xt()), e5.byteLength !== 0 && e5.ranges.add(0, e5.byteLength), e5;
          }
          return r3(u4, [{
            key: "_tryExtend",
            value: function(e5, t4, n4) {
              if (e5 === 0 && this.byteLength === 0 && n4) {
                var r4 = new DataView(n4.buffer || n4, n4.byteOffset, n4.byteLength);
                this._swapDataView(r4);
              } else {
                var i4 = e5 + t4;
                if (i4 > this.byteLength) {
                  var a4 = this._extend(i4).dataView;
                  this._swapDataView(a4);
                }
              }
            }
          }, {
            ...
            value: function(e5) {
              var t4;
              t4 = _3 ? j3.allocUnsafe(e5) : new Uint8Array(e5);
              var n4 = new DataView(t4.buffer, t4.byteOffset, t4.byteLength);
              return t4.set(new Uint8Array(this.buffer, this.byteOffset, this.byteLength), 0), {
                uintView: t4,
                dataView: n4
              };
            }
            ...
            value: function(e5, t4) {
              ...
              return t4 = t4 || this._lengthToEnd(e5), n4 && this._tryExtend(e5, t4), this.ranges.add(e5, t4), v3(s3(u4.prototype), "subarray", this).call(this, e5, t4);
            }
          }, {
            key: "set",
            value: function(e5, t4) {
              var n4 = arguments.length > 2 && arguments[2] !== void 0 && arguments[2];
              n4 && this._tryExtend(t4, e5.byteLength, e5);
              var r4 = v3(s3(u4.prototype), "set", this).call(this, e5, t4);
              return this.ranges.add(t4, r4.byteLength), r4;
            }
          }, {
            key: "ensureChunk",
            value: function(e5, t4) {
              try {
                ...
                if (!n4.chunked)
                  return;
                if (n4.ranges.available(e5, t4))
                  return;
                return function(e6, t5) {
                  if (!t5)
                    return e6 && e6.then ? e6.then(Pt) : Promise.resolve();
                }(n4.readChunk(e5, t4));
              } catch (e6) {
                return Promise.reject(e6);
              }
            ...
            key: "available",
            value: function(e5, t4) {
              return this.ranges.available(e5, t4);
            }
          }]), u4;
        }(D2), xt = function() {
          function e4() {
            t3(this, e4), i3(this, "list", []);
          }
          return r3(e4, [{
            key: "length",
            get: function() {
            ...
            key: "add",
            value: function(e5, t4) {
              var n3 = e5 + t4, r4 = this.list.filter(function(t5) {
                return Ct(e5, t5.offset, n3) || Ct(e5, t5.end, n3);
              });
              if (r4.length > 0) {
                e5 = Math.min.apply(Math, [e5].concat(r4.map(function(e6) {
                  return e6.offset;
                }))), t4 = (n3 = Math.max.apply(Math, [n3].concat(r4.map(function(e6) {
                  return e6.end;
                })))) - e5;
                var i4 = r4.shift();
                i4.offset = e5, i4.length = t4, i4.end = n3, this.list = this.list.filter(function(e6) {
                  return !r4.includes(e6);
                });
              } else
                this.list.push({
                  offset: e5,
            ...
            value: function(e5, t4) {
              var n3 = e5 + t4;
              return this.list.some(function(t5) {
                return t5.offset <= e5 && n3 <= t5.end;
              });
            }
          }]), e4;
        }();
        ...
        function jt(e4, t4) {
          if (!t4)
            return e4 && e4.then ? e4.then(Bt) : Promise.resolve();
        }
        function _t(e4, t4, n3) {
          return n3 ? t4 ? t4(e4) : e4 : (e4 && e4.then || (e4 = Promise.resolve(e4)), t4 ? e4.then(t4) : e4);
        }
        var Vt = function(e4) {
          a3(i4, e4);
          ...
          return r3(i4, [{
            ...
            value: function() {
              try {
                var e5 = this;
                return e5.chunked = false, _t(Y(e5.input), function(t4) {
                  e5._swapArrayBuffer(t4);
                });
              } catch (e6) {
                return Promise.reject(e6);
              }
            ...
            key: "readChunked",
            value: function() {
              return this.chunked = true, this.size = this.input.size, v3(s3(i4.prototype), "readChunked", this).call(this);
            }
          }, {
            key: "_readChunk",
            value: function(e5, t4) {
              try {
                var n4 = this, r4 = t4 ? e5 + t4 : void 0, i5 = n4.input.slice(e5, r4);
                return _t(Y(i5), function(t5) {
                  return n4.set(t5, e5, true);
                });
              } catch (e6) {
                return Promise.reject(e6);
              }
          ...
          function s4(e5, r4) {
            var a4;
            return t3(this, s4), i3(h3(a4 = n3.call(this, 0)), "chunksRead", 0), a4.input = e5, a4.options = r4, a4;
          }
          return r3(s4, [{
            key: "readWhole",
            value: function() {
              try {
                var e5 = this;
                return e5.chunked = false, jt(e5.readChunk(e5.nextChunkOffset));
              } catch (e6) {
                return Promise.reject(e6);
              }
            }
            ...
            value: function() {
              try {
                var e5 = this;
                return e5.chunked = true, jt(e5.readChunk(0, e5.options.firstChunkSize));
              } catch (e6) {
                return Promise.reject(e6);
              }
            }
            ...
            value: function(e5) {
              try {
                var t4 = this;
                if (e5 === void 0 && (e5 = t4.nextChunkOffset), t4.fullyRead)
                  return t4.chunksRead++, false;
                var n4 = t4.options.chunkSize;
                return r4 = t4.readChunk(e5, n4), i4 = function(e6) {
                  return !!e6 && e6.byteLength === n4;
                }, a4 ? i4 ? i4(r4) : r4 : (r4 && r4.then || (r4 = Promise.resolve(r4)), i4 ? r4.then(i4) : r4);
              } catch (e6) {
                return Promise.reject(e6);
              }
              var r4, i4, a4;
            ...
            value: function(e5, t4) {
              try {
                var n4 = this;
                if (n4.chunksRead++, (t4 = n4.safeWrapAddress(e5, t4)) === 0)
                  return;
                return n4._readChunk(e5, t4);
              } catch (e6) {
                return Promise.reject(e6);
              }
            }
            ...
            key: "safeWrapAddress",
            value: function(e5, t4) {
              return this.size !== void 0 && e5 + t4 > this.size ? Math.max(0, this.size - e5) : t4;
            }
          }, {
            key: "nextChunkOffset",
            get: function() {
        ...
        K.set("blob", Vt), e3.Exifr = Ie, e3.Options = Pe, e3.allFormatters = be, e3.chunkedProps = de, e3.createDictionary = te, e3.default = at, e3.disableAllOptions = lt, e3.extendDictionary = ne, e3.fetchUrlAsArrayBuffer = G, e3.fileParsers = M2, e3.fileReaders = K, e3.gps = ft, e3.gpsOnlyOptions = dt, e3.inheritables = me, e3.orientation = ot, e3.orientationOnlyOptions = vt, e3.otherSegments = ve, e3.parse = Te, e3.readBlobAsArrayBuffer = Y, e3.rotation = function(t4) {
          return st(ot(t4), function(t5) {
            return g3({
              canvas: e3.rotateCanvas,
              css: e3.rotateCss
            }, yt[t5]);
          });
        }, e3.rotations = yt, e3.segmentParsers = W, e3.segments = pe, e3.segmentsAndBlocks = ge, e3.tagKeys = re, e3.tagRevivers = ae, e3.tagValues = ie, e3.thumbnail = ht, e3.thumbnailOnlyOptions = pt, e3.thumbnailUrl = ct, e3.tiffBlocks = ye, e3.tiffExtractables = ke, Object.defineProperty(e3, "__esModule", {
          value: true
        });
      });
    }
  ...
  var require_FileInfo = __commonJS({
    "../packages/@uppy/dashboard/lib/components/FileItem/FileInfo/index.js"(exports, module) {
      ...
      var renderAuthor = (props) => {
        ...
        }, truncateString(author.name, 13)), providerName ? h3(Fragment, null, ` ${dot} `, providerName) : null);
      };
